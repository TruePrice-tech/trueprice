...
export async function runDraftDispute(rawArgs: unknown) {
  ...
  switch (parsed.issue_type) {
    ...
    case "refrigerant_compliance":
      ...
      body = `Regarding the HVAC equipment quoted for ${address}: ${parsed.issue_detail}\n\nUnder the EPA AIM Act Technology Transitions rule, manufacture and import of new R-410A residential AC and heat pump equipment was prohibited as of January 1, 2025. Installation of newly-manufactured R-410A systems is restricted starting January 1, 2026, though EPA has deprioritized enforcement for pre-2025-manufactured inventory and a proposed clarifying rule is pending. New equipment generally uses A2L refrigerants such as R-454B or R-32.\n\nPlease confirm in writing:\n- The exact refrigerant in the proposed equipment (R-454B, R-32, R-410A, or other)\n- If R-410A: the equipment's manufacture date, and whether it is pre-2025 inventory disclosed as such\n- Whether the equipment is current production or end-of-life inventory\n- The manufacturer's parts/warranty terms and whether warranty service remains available for this refrigerant going forward\n- Long-term refrigerant availability for service/recharge over the equipment's lifespan\n\nInstalling end-of-life refrigerant equipment can lead to higher service costs, scarce parts, and complications during future replacement.`;
      break;
    case "efficiency_below_code":
      subject = "Equipment Efficiency Below Federal Minimum";
      body = `Regarding the HVAC system quoted for ${address}: ${parsed.issue_detail}\n\nThe U.S. Department of Energy minimum efficiency standard for new residential AC and heat pump installs (effective January 1, 2023) is expressed in SEER2 (a more stringent test method than legacy SEER). Federal minimum is **14.3 SEER2 in the Southeast and Southwest** (≈15 SEER) and **13.4 SEER2 in the North** (≈14 SEER). Equipment below that threshold cannot legally be installed as a new system.\n\nPlease provide:\n- The exact SEER2 rating of the proposed equipment (and SEER if separately listed)\n- Confirmation the equipment meets or exceeds federal minimum standards for my region\n- Documentation that this equipment qualifies for any applicable Inflation Reduction Act tax credits if you marketed those\n\nIf the proposed unit does not meet code, please re-quote with compliant equipment.`;
      break;
