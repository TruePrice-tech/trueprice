...
export async function runDraftDispute(args: unknown) {
  ...
  switch (parsed.issue_type) {
    ...
    case "warranty_inadequate":
      ...
      body = `Regarding the roofing project quote for ${address}: ${parsed.issue_detail}\n\nA reputable roof replacement should include two separate warranties, and I need clarity on both:\n\n1. **Manufacturer material warranty.** Major architectural shingles (GAF Timberline, OC Duration, CertainTeed Landmark, Malarkey) carry "limited lifetime" warranties — but the meaningful number is the **non-prorated period** (typically 10 years standard, extendable to 50 years only via certified-contractor system warranties such as GAF Golden Pledge or OC Platinum). After the non-prorated period, coverage is **pro-rated** and labor is typically NOT covered. Transferability is limited (often one transfer within the first few years), and registration within 30-60 days is often required.\n\n2. **Contractor workmanship warranty.** Industry standard is at least 10 years for full replacement. This is separate from the manufacturer warranty and covers installation defects.\n\nI need in writing before signing:\n- The exact manufacturer warranty: standard or upgraded/system? What is the non-prorated period, and is labor included?\n- Registration requirements and deadline\n- Transferability terms\n- The contractor workmanship warranty length and exactly what it covers\n- If the workmanship warranty is shorter than 10 years, why — or please extend it as a condition of the contract.`;
      break;
