...
const VERTICAL_CONFIG = {
  ...
  painting: {
    ...
    statePrefixOnly: true,
    skipCityPattern: /^[a-z][a-z0-9-]*-[a-z]{2}-painting-cost\.html$/,
  },
  landscaping: {
    fileSuffix: "-landscaping-cost.html",
    statePrefixOnly: true,
    skipCityPattern: /^[a-z][a-z0-9-]*-[a-z]{2}-landscaping-cost\.html$/,
  },
  insulation: {
    fileSuffix: "-insulation-cost.html",
    statePrefixOnly: true,
    skipCityPattern: /^[a-z][a-z0-9-]*-[a-z]{2}-insulation-cost\.html$/,
  },
  concrete: {
    fileSuffix: "-concrete-cost.html",
    statePrefixOnly: true,
    skipCityPattern: /^[a-z][a-z0-9-]*-[a-z]{2}-concrete-cost\.html$/,
  },
  foundation: {
    fileSuffix: "-foundation-cost.html",
    statePrefixOnly: true,
    skipCityPattern: /^[a-z][a-z0-9-]*-[a-z]{2}-foundation-cost\.html$/,
  },
  "garage-door": {
  ...
  legal: {
    ...
    statePrefixOnly: true,
    skipCityPattern: /^[a-z][a-z0-9-]*-[a-z]{2}-legal-cost\.html$/,
  },
  medical: {
    fileSuffix: "-medical-cost.html",
    statePrefixOnly: true,
    skipCityPattern: /^[a-z][a-z0-9-]*-[a-z]{2}-medical-cost\.html$/,
  },
  moving: {
    fileSuffix: "-moving-cost.html",
    statePrefixOnly: true,
    skipCityPattern: /^[a-z][a-z0-9-]*-[a-z]{2}-moving-cost\.html$/,
  },
};
