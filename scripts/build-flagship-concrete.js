...
const CITY_CONCRETE_DATA = {
  ...
  "st-louis-mo": {
    soilPara: "St. Louis sits on Missouri River alluvium and Mississippian limestone with windblown loess on the bluffs. Residential lots show variable depth to competent bearing across the metro, and geotechnical investigation is recommended before any structural slab work. The local soil profile drives both excavation difficulty and footing design across neighborhoods like Central West End, Soulard, Clayton.",
    mixPara: "The St. Louis residential concrete spec is 4,500 psi with 6-7 percent entrained air, Type I/II cement for freeze-thaw resistance, and compliance with local building department standards. Buzzi Unicem, Holcim, and Fred Weber supply most of the St. Louis delivery radius. Winter pours require insulated blanket curing and protection plans.",
    rebarPara: "#4 rebar on 18-inch centers is the standard residential reinforcement in St. Louis. Standard rebar reinforcement handles the local soil conditions when properly detailed.",
    climatePara: "St. Louis averages about 60 freeze-thaw cycles per year, a moderate freeze-thaw load that still requires air-entrained mix and proper curing. The area receives approximately 42 inches of precipitation annually.",
    disasterPara: "St. Louis has experienced periodic ice storm damage that cracks partially cured concrete during winter pour events. Reputable St. Louis contractors reference these events when specifying protective measures.",
    permitPara: "City of St. Louis Building Division handles residential concrete permits. Central West End and Clayton have distinct permitting timelines. Local zoning overlays may restrict driveway width and impervious coverage in residential districts.",
    setbackPara: "St. Louis zoning code restricts driveway width and requires setbacks from property lines in residential zones. Central West End and Soulard lots often have specific deed restrictions or HOA requirements layered on top of municipal code.",
    stylePara: "Residential concrete in St. Louis centers on broom-finish driveways, replacement front walks, and walkout-basement foundation work typical of neighborhoods like Central West End and Soulard.",
    decorativePara: "Stamped flagstone patterns, exposed-aggregate finishes, and salt-finish textures for traction are the popular decorative choices in St. Louis. Local pigment and aggregate supply match the regional aesthetic.",
    seasonPara: "St. Louis pours best from March through November. Winter pours in January and February require cold-weather protection protocols.",
    scenarioNotes: "Limestone or caliche excavation adds $400-$1,200 per footing. Labor rates in St. Louis are at or near the national average.",
...
const CITY_CONCRETE_EXTRA = {
  "st-louis-mo": {
    localProjectPara: `The most common residential concrete projects in St Louis neighborhoods like Central West End and Soulard include driveway replacement driven by deicing-salt scaling, front-walk reconstruction after frost-heave displacement, and walkout-basement patio pours that require drainage engineering for the local Missouri River alluvium and Mississippian limestone subgrade. City of St. Louis Building Division handles permits with typical turnaround of 5-10 business days. The Hill and Tower Grove South suburban developments often have HOA standards specifying acceptable concrete finishes and colors.`,
    weatherImpactPara: `St Louis's 60 freeze-thaw cycles annually, 42 inches of rain, and severe spring thunderstorms creates specific concrete challenges. The April 2011 Good Friday EF4 tornado that devastated north county and Lambert Airport demonstrated the vulnerability of exposed concrete to extreme weather events. Ameren Missouri and Spire coordinate utility locates through 811 before any excavation. The red oak canopy in Central West End and Soulard creates root-heave risk on sidewalks and requires root-barrier specification on new pours within 15 feet of mature trees.`,
    contractorVerifyPara: `St Louis concrete contractor verification: Missouri has no statewide contractor license; city registration required. Ameren Missouri service coordination for any work near utility lines runs through the 811 call-before-you-dig system. Lafayette Square, Soulard, and Compton Heights are the primary protected historic districts under the Cultural Resources Office; historic district overlays may restrict driveway width, finish style, or impervious surface coverage. Washington University and Saint Louis University campus-area properties in Soulard and Central West End face additional access and scheduling constraints during the academic year.`,
  },
  "orlando-fl": {
    localProjectPara: `The most common residential concrete projects in Orlando neighborhoods like Winter Park and College Park include pool-deck extensions, driveway apron widening for expanded parking, and covered-patio slab pours that must account for the local Central Florida sand over Ocala limestone bearing conditions. City of Orlando Permitting Services handles permits with typical turnaround of 5-10 business days. Lake Nona and Windermere suburban developments often have HOA standards specifying acceptable concrete finishes and colors.`,
    weatherImpactPara: `Orlando's zero freeze-thaw cycles, 50 inches of rain concentrated in summer thunderstorms, and direct hurricane exposure creates specific concrete challenges. Hurricane Ian 2022 and Hurricane Irma 2017 which both affected the Central Florida metro demonstrated the vulnerability of exposed concrete to extreme weather events. OUC and Duke Energy Florida and TECO Peoples Gas coordinate utility locates through 811 before any excavation. The live oak canopy in Winter Park and College Park creates root-heave risk on sidewalks and requires root-barrier specification on new pours within 15 feet of mature trees.`,
    contractorVerifyPara: `Orlando concrete contractor verification: Florida DBPR licenses contractors; verify at myfloridalicense.com. OUC and Duke Energy Florida service coordination for any work near utility lines runs through the 811 call-before-you-dig system. Lake Eola Heights, Colonialtown, and Thornton Park historic districts are under the Orlando Historic Preservation Board; historic district overlays may restrict driveway width, finish style, or impervious surface coverage. University of Central Florida and Rollins College campus-area properties in College Park and Winter Park face additional access and scheduling constraints during the academic year.`,
  },
  "san-antonio-tx": {
    localProjectPara: `The most common residential concrete projects in San Antonio neighborhoods like Alamo Heights and Stone Oak include patio installation, driveway replacement, and foundation-adjacent flatwork that must account for the local Balcones Fault Zone clay and Edwards limestone soil conditions. City of San Antonio Development Services handles permits with typical turnaround of 5-10 business days. The Pearl and Boerne suburban developments often have HOA standards specifying acceptable concrete finishes and colors.`,
    weatherImpactPara: `San Antonio's 5 freeze-thaw cycles, 32 inches of rain, and extreme summer heat exceeding 100F for 30+ days creates specific concrete challenges. The February 2021 Winter Storm Uri that knocked out power across the entire ERCOT grid for 4-5 days demonstrated the vulnerability of exposed concrete to extreme weather events. CPS Energy and CPS Energy (combined utility) coordinate utility locates through 811 before any excavation. The live oak canopy in Alamo Heights and Stone Oak creates root-heave risk on sidewalks and requires root-barrier specification on new pours within 15 feet of mature trees.`,
    contractorVerifyPara: `San Antonio concrete contractor verification: Texas has no statewide residential contractor license; TDLR registers mechanical and electrical trades only. CPS Energy service coordination for any work near utility lines runs through the 811 call-before-you-dig system. King William, Monte Vista, and Dignowity Hill are among 10+ historic districts under the HDRC; historic district overlays may restrict driveway width, finish style, or impervious surface coverage. UTSA, Trinity University, and the Alamo Colleges District campus-area properties in Stone Oak and Alamo Heights face additional access and scheduling constraints during the academic year.`,
  },
  "portland-or": {
    localProjectPara: `The most common residential concrete projects in Portland neighborhoods like Pearl District and Alberta Arts include patio installation, driveway replacement, and foundation-adjacent flatwork that must account for the local Willamette River alluvium over Columbia River basalt soil conditions. City of Portland Bureau of Development Services handles permits with typical turnaround of 5-10 business days. Sellwood and Laurelhurst suburban developments often have HOA standards specifying acceptable concrete finishes and colors.`,
    weatherImpactPara: `Portland's 15 freeze-thaw cycles, 43 inches of rain concentrated October-May, and persistent winter moisture creates specific concrete challenges. The January 2021 ice storm that coated the metro in 1-2 inches of ice and damaged thousands of homes demonstrated the vulnerability of exposed concrete to extreme weather events. Portland General Electric (PGE) and NW Natural coordinate utility locates through 811 before any excavation. The Douglas fir canopy in Pearl District and Alberta Arts creates root-heave risk on sidewalks and requires root-barrier specification on new pours within 15 feet of mature trees.`,
    contractorVerifyPara: `Portland concrete contractor verification: Oregon CCB license required; verify at ccb.oregon.gov. Portland General Electric (PGE) service coordination for any work near utility lines runs through the 811 call-before-you-dig system. Irvington, Ladd's Addition, Piedmont, and Lair Hill historic districts are under the Portland Historic Landmarks Commission; historic district overlays may restrict driveway width, finish style, or impervious surface coverage. Portland State University, Reed College, and Lewis & Clark College campus-area properties in Alberta Arts and Pearl District face additional access and scheduling constraints during the academic year.`,
  },
  "sacramento-ca": {
    localProjectPara: `The most common residential concrete projects in Sacramento neighborhoods like East Sacramento and Midtown include patio installation, driveway replacement, and foundation-adjacent flatwork that must account for the local Sacramento Valley alluvial clay and American River sand soil conditions. City of Sacramento Community Development handles permits with typical turnaround of 5-10 business days. Roseville and Folsom suburban developments often have HOA standards specifying acceptable concrete finishes and colors.`,
    weatherImpactPara: `Sacramento's 12 freeze-thaw cycles, only 18 inches of rain, and Central Valley summer heat exceeding 100F for 60+ days creates specific concrete challenges. The January 2023 atmospheric river sequence that produced record flooding across the Sacramento Valley demonstrated the vulnerability of exposed concrete to extreme weather events. SMUD and PG&E coordinate utility locates through 811 before any excavation. The valley oak canopy in East Sacramento and Midtown creates root-heave risk on sidewalks and requires root-barrier specification on new pours within 15 feet of mature trees.`,
    contractorVerifyPara: `Sacramento concrete contractor verification: California requires specific contractor licenses through CSLB; verify at cslb.ca.gov. SMUD service coordination for any work near utility lines runs through the 811 call-before-you-dig system. Alkali Flat, Boulevard Park, and Poverty Ridge are under the Sacramento Preservation Commission; historic district overlays may restrict driveway width, finish style, or impervious surface coverage. UC Davis, Sacramento State, and McGeorge School of Law campus-area properties in Midtown and East Sacramento face additional access and scheduling constraints during the academic year.`,
  },
  "pittsburgh-pa": {
    localProjectPara: `The most common residential concrete projects in Pittsburgh neighborhoods like Shadyside and Squirrel Hill include driveway replacement driven by deicing-salt scaling, front-walk reconstruction after frost-heave displacement, and walkout-basement patio pours that require drainage engineering for the local Allegheny Plateau sandstone and shale subgrade. City of Pittsburgh PLI handles permits with typical turnaround of 5-10 business days. Mt. Lebanon and Fox Chapel suburban developments often have HOA standards specifying acceptable concrete finishes and colors.`,
    weatherImpactPara: `Pittsburgh's 75 freeze-thaw cycles, 38 inches of rain, and heavy winter snow loading from Great Lakes moisture creates specific concrete challenges. The June 2012 derecho and the August 2019 windstorm that produced widespread damage across Allegheny County demonstrated the vulnerability of exposed concrete to extreme weather events. Duquesne Light and Peoples Gas coordinate utility locates through 811 before any excavation. The red oak canopy in Shadyside and Squirrel Hill creates root-heave risk on sidewalks and requires root-barrier specification on new pours within 15 feet of mature trees.`,
    contractorVerifyPara: `Pittsburgh concrete contractor verification: Pennsylvania requires HIC registration under Act 132; verify at pago.state.pa.us. Duquesne Light service coordination for any work near utility lines runs through the 811 call-before-you-dig system. Allegheny West, Manchester, Mexican War Streets, and Deutschtown are under the Pittsburgh Historic Review Commission; historic district overlays may restrict driveway width, finish style, or impervious surface coverage. University of Pittsburgh and Carnegie Mellon University campus-area properties in Squirrel Hill and Shadyside face additional access and scheduling constraints during the academic year.`,
  },
  "columbus-oh": {
    localProjectPara: `The most common residential concrete projects in Columbus neighborhoods like German Village and Short North include driveway replacement driven by deicing-salt scaling, front-walk reconstruction after frost-heave displacement, and walkout-basement patio pours that require drainage engineering for the local glacial till over Devonian shale and Ohio limestone subgrade. City of Columbus Building and Zoning Services handles permits with typical turnaround of 5-10 business days. Dublin and Worthington suburban developments often have HOA standards specifying acceptable concrete finishes and colors.`,
    weatherImpactPara: `Columbus's 80 freeze-thaw cycles, 40 inches of rain, and occasional severe thunderstorms creates specific concrete challenges. The June 2012 derecho that produced widespread power outages and property damage across Franklin County demonstrated the vulnerability of exposed concrete to extreme weather events. AEP Ohio and Columbia Gas of Ohio coordinate utility locates through 811 before any excavation. The sugar maple canopy in German Village and Short North creates root-heave risk on sidewalks and requires root-barrier specification on new pours within 15 feet of mature trees.`,
    contractorVerifyPara: `Columbus concrete contractor verification: Ohio has no statewide residential contractor license; Columbus requires local registration. AEP Ohio service coordination for any work near utility lines runs through the 811 call-before-you-dig system. German Village, Victorian Village, and Italian Village are under the Columbus Historic Preservation Commission; historic district overlays may restrict driveway width, finish style, or impervious surface coverage. The Ohio State University, Capital University, and Otterbein University campus-area properties in Short North and German Village face additional access and scheduling constraints during the academic year.`,
  },
  "kansas-city-mo": {
    localProjectPara: `The most common residential concrete projects in Kansas City neighborhoods like Country Club Plaza and Brookside include driveway replacement driven by deicing-salt scaling, front-walk reconstruction after frost-heave displacement, and walkout-basement patio pours that require drainage engineering for the local Kansas City Group limestone and Missouri River loess subgrade. Kansas City Permits and Inspections handles permits with typical turnaround of 5-10 business days. Prairie Village and Lee's Summit suburban developments often have HOA standards specifying acceptable concrete finishes and colors.`,
    weatherImpactPara: `Kansas City's 80 freeze-thaw cycles, 39 inches of rain, and severe spring supercells in the central US hail corridor creates specific concrete challenges. The May 2024 supercell hail event that produced widespread damage across Johnson County KS and the March 2022 tornado outbreak demonstrated the vulnerability of exposed concrete to extreme weather events. Evergy and Spire coordinate utility locates through 811 before any excavation. The bur oak canopy in Country Club Plaza and Brookside creates root-heave risk on sidewalks and requires root-barrier specification on new pours within 15 feet of mature trees.`,
    contractorVerifyPara: `Kansas City concrete contractor verification: Missouri has no statewide roofer license; Kansas requires contractor registration through the Attorney General. The metro straddles both states. Evergy service coordination for any work near utility lines runs through the 811 call-before-you-dig system. Country Club Plaza, Pendleton Heights, and Janssen Place are under the KCMO Historic Preservation Commission; Kansas-side municipalities have limited historic protections; historic district overlays may restrict driveway width, finish style, or impervious surface coverage. UMKC, University of Kansas (Lawrence), and Rockhurst University campus-area properties in Brookside and Country Club Plaza face additional access and scheduling constraints during the academic year.`,
  },
  "indianapolis-in": {
    localProjectPara: `The most common residential concrete projects in Indianapolis neighborhoods like Broad Ripple and Meridian-Kessler include driveway replacement driven by deicing-salt scaling, front-walk reconstruction after frost-heave displacement, and walkout-basement patio pours that require drainage engineering for the local Wisconsin-age glacial till and Silurian-Devonian limestone subgrade. Indianapolis Department of Business and Neighborhood Services handles permits with typical turnaround of 5-10 business days. Fishers and Zionsville suburban developments often have HOA standards specifying acceptable concrete finishes and colors.`,
    weatherImpactPara: `Indianapolis's 85 freeze-thaw cycles, 42 inches of rain, and spring supercell exposure in the tornado corridor creates specific concrete challenges. The November 2013 EF2 tornado in Washington Township and the April 2023 spring hail event that damaged thousands of homes demonstrated the vulnerability of exposed concrete to extreme weather events. AES Indiana and CenterPoint Energy Indiana coordinate utility locates through 811 before any excavation. The tulip poplar canopy in Broad Ripple and Meridian-Kessler creates root-heave risk on sidewalks and requires root-barrier specification on new pours within 15 feet of mature trees.`,
    contractorVerifyPara: `Indianapolis concrete contractor verification: Indiana has no statewide residential contractor license but requires Marion County registration. AES Indiana service coordination for any work near utility lines runs through the 811 call-before-you-dig system. Irvington, Lockerbie Square, Woodruff Place, and Herron-Morton Place are under the Indianapolis Historic Preservation Commission; historic district overlays may restrict driveway width, finish style, or impervious surface coverage. Indiana University-Purdue University Indianapolis (IUPUI), Butler University, and Marian University campus-area properties in Meridian-Kessler and Broad Ripple face additional access and scheduling constraints during the academic year.`,
  },
  "nashville-tn": {
    localProjectPara: `The most common residential concrete projects in Nashville neighborhoods like East Nashville and 12South include patio installation, driveway replacement, and foundation-adjacent flatwork that must account for the local Middle Tennessee Basin limestone and Ordovician phosphatic clay soil conditions. Metro Nashville Department of Codes Administration handles permits with typical turnaround of 5-10 business days. Franklin and Brentwood suburban developments often have HOA standards specifying acceptable concrete finishes and colors.`,
    weatherImpactPara: `Nashville's 40 freeze-thaw cycles, 48 inches of rain, and severe spring thunderstorms in the Nashville Basin creates specific concrete challenges. The March 2020 EF3 tornado that devastated East Nashville, Germantown, Donelson, and Mt. Juliet demonstrated the vulnerability of exposed concrete to extreme weather events. Nashville Electric Service (NES) and Piedmont Natural Gas coordinate utility locates through 811 before any excavation. The eastern red cedar canopy in East Nashville and 12South creates root-heave risk on sidewalks and requires root-barrier specification on new pours within 15 feet of mature trees.`,
    contractorVerifyPara: `Nashville concrete contractor verification: Tennessee requires a Home Improvement License for projects over $3,000 through the Tennessee Board for Licensing Contractors. Nashville Electric Service (NES) service coordination for any work near utility lines runs through the 811 call-before-you-dig system. East Nashville, Germantown, and Lockeland Springs are under the Metro Nashville Historic Zoning Commission; historic district overlays may restrict driveway width, finish style, or impervious surface coverage. Vanderbilt University, Belmont University, and Tennessee State University campus-area properties in 12South and East Nashville face additional access and scheduling constraints during the academic year.`,
  },
};
