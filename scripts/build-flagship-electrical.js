...
const CITY_ELECTRICAL_DATA = {
  ...
  "st-louis-mo": {
    utilityPara: "Ameren Missouri serves the St. Louis metro area. Service coordination for residential panel upgrades runs 10-20 business days from completed application. The utility handles all meter and service-entrance coordination for residential upgrades.",
    codePara: "St. Louis follows the NEC as adopted by the state with local amendments. Romex is permitted for residential wiring, keeping labor costs competitive in St. Louis.",
    panelPara: "St. Louis housing stock includes pre-war and mid-century homes with 60-150 amp panels and newer construction with 200-amp service. Modern all-electric retrofits with heat pumps and EV chargers routinely require 200-amp service upgrades coordinated with Ameren Missouri. Neighborhoods like Central West End and Soulard show distinct housing-era panel profiles.",
    homeStockPara: "St. Louis homes range from slab-on-grade and crawl-space construction in older neighborhoods to modern tract homes in the suburbs. Central West End and Clayton represent different construction eras with distinct wiring access challenges.",
    licensePara: "State licensing applies and St. Louis may require additional local registration. St. Louis homeowners should verify both state licensure and local business registration before signing.",
    permitPara: "City of St. Louis Building Division issues electrical permits, typically in 1-4 weeks for standard residential work. Ameren Missouri service coordination runs 2-4 weeks parallel to the city permit. Historic districts in Central West End or Soulard may add preservation commission review for visible exterior work.",
    hazardPara: "Federal Pacific Stab-Lok panels are common in 1960s-70s St. Louis homes and remain a documented fire hazard. Aluminum branch circuit wiring shows up in 1965-1975 construction. Ice-storm-damaged service masts and frozen exterior disconnects are recurring hazard categories.",
    renoPara: "EV charger installation is the fastest-growing residential electrical scope in St. Louis. A typical installation runs $1,400-$3,500 depending on circuit length and panel capacity.",
    pricingContext: "St. Louis electrical labor runs at or slightly above the national average. Ameren Missouri coordination delays can push panel-upgrade timelines 2-4 weeks beyond initial estimates.",
    seasonPara: "St. Louis electrical demand peaks April-June and September-October. Winter ice storms drive emergency service-mast repairs. Off-peak scheduling saves 8-15% on labor."
  },
...
const CITY_ELECTRICAL_EXTRA = {
  "st-louis-mo": {
    localUtilityPara: `Ameren Missouri serves the St Louis metro with residential service coordination for panel upgrades typically running 10-20 business days. Spire handles gas service where applicable. St Louis's housing stock across Central West End and Soulard spans construction eras from pre-war to modern, with corresponding electrical infrastructure ranging from 60-amp fuse panels to modern 200-amp breaker service. The April 2011 Good Friday EF4 tornado that devastated north county and Lambert Airport highlighted the importance of whole-house generator systems, which have become a standard residential electrical scope in St Louis.`,
    panelAndCodePara: `City of St. Louis Building Division handles electrical permits. Missouri has no statewide contractor license; city registration required. St Louis homes in Central West End and Clayton show distinct housing-era electrical profiles: pre-1965 construction may have aluminum branch wiring or Federal Pacific Stab-Lok panels (documented fire hazards), while post-2000 construction typically has 200-amp service with AFCI protection on bedroom circuits. EV charger installation is the fastest-growing residential electrical scope in St Louis, with Level 2 (240V, 40-amp) installations running $1,400-$3,500 depending on panel capacity and circuit length.`,
    safetyAndLicensePara: `Lafayette Square, Soulard, and Compton Heights are the primary protected historic districts under the Cultural Resources Office; visible exterior electrical work on contributing structures may require preservation commission review. Missouri does not require annual vehicle safety inspections but requires emissions testing in the St. Louis metro. Federal Pacific Stab-Lok panels and Zinsco panels are documented fire hazards found in 1960s-1970s St Louis homes; replacement with modern Siemens, Square D, or Eaton panels is a safety-critical upgrade. Washington University and Saint Louis University area properties in Central West End may have rental-grade electrical systems that need upgrading for owner-occupancy.`,
  },
  "orlando-fl": {
    localUtilityPara: `OUC and Duke Energy Florida serves the Orlando metro with residential service coordination for panel upgrades typically running 10-20 business days. TECO Peoples Gas handles gas service where applicable. Orlando's housing stock across Winter Park and College Park spans construction eras from pre-war to modern, with corresponding electrical infrastructure ranging from 60-amp fuse panels to modern 200-amp breaker service. Hurricane Ian 2022 and Hurricane Irma 2017 which both affected the Central Florida metro highlighted the importance of whole-house generator systems, which have become a standard residential electrical scope in Orlando.`,
    panelAndCodePara: `City of Orlando Permitting Services handles electrical permits. Florida DBPR licenses contractors; verify at myfloridalicense.com. Orlando homes in Winter Park and Dr. Phillips show distinct housing-era electrical profiles: pre-1965 construction may have aluminum branch wiring or Federal Pacific Stab-Lok panels (documented fire hazards), while post-2000 construction typically has 200-amp service with AFCI protection on bedroom circuits. EV charger installation is the fastest-growing residential electrical scope in Orlando, with Level 2 (240V, 40-amp) installations running $1,400-$3,500 depending on panel capacity and circuit length.`,
    safetyAndLicensePara: `Lake Eola Heights, Colonialtown, and Thornton Park historic districts are under the Orlando Historic Preservation Board; visible exterior electrical work on contributing structures may require preservation commission review. Florida does not require vehicle safety inspections or emissions testing. Federal Pacific Stab-Lok panels and Zinsco panels are documented fire hazards found in 1960s-1970s Orlando homes; replacement with modern Siemens, Square D, or Eaton panels is a safety-critical upgrade. University of Central Florida and Rollins College area properties in Winter Park may have rental-grade electrical systems that need upgrading for owner-occupancy.`,
  },
  "san-antonio-tx": {
    localUtilityPara: `CPS Energy serves the San Antonio metro with residential service coordination for panel upgrades typically running 10-20 business days. CPS Energy (combined utility) handles gas service where applicable. San Antonio's housing stock across Alamo Heights and Stone Oak spans construction eras from pre-war to modern, with corresponding electrical infrastructure ranging from 60-amp fuse panels to modern 200-amp breaker service. The February 2021 Winter Storm Uri that knocked out power across the entire ERCOT grid for 4-5 days highlighted the importance of whole-house generator systems, which have become a standard residential electrical scope in San Antonio.`,
    panelAndCodePara: `City of San Antonio Development Services handles electrical permits. Texas has no statewide residential contractor license; TDLR registers mechanical and electrical trades only. San Antonio homes in Alamo Heights and King William show distinct housing-era electrical profiles: pre-1965 construction may have aluminum branch wiring or Federal Pacific Stab-Lok panels (documented fire hazards), while post-2000 construction typically has 200-amp service with AFCI protection on bedroom circuits. EV charger installation is the fastest-growing residential electrical scope in San Antonio, with Level 2 (240V, 40-amp) installations running $1,400-$3,500 depending on panel capacity and circuit length.`,
    safetyAndLicensePara: `King William, Monte Vista, and Dignowity Hill are among 10+ historic districts under the HDRC; visible exterior electrical work on contributing structures may require preservation commission review. Texas requires annual safety and emissions inspection at $25.50 combined fee. Federal Pacific Stab-Lok panels and Zinsco panels are documented fire hazards found in 1960s-1970s San Antonio homes; replacement with modern Siemens, Square D, or Eaton panels is a safety-critical upgrade. UTSA, Trinity University, and the Alamo Colleges District area properties in Alamo Heights may have rental-grade electrical systems that need upgrading for owner-occupancy.`,
  },
  "portland-or": {
    localUtilityPara: `Portland General Electric (PGE) serves the Portland metro with residential service coordination for panel upgrades typically running 10-20 business days. NW Natural handles gas service where applicable. Portland's housing stock across Pearl District and Alberta Arts spans construction eras from pre-war to modern, with corresponding electrical infrastructure ranging from 60-amp fuse panels to modern 200-amp breaker service. The January 2021 ice storm that coated the metro in 1-2 inches of ice and damaged thousands of homes highlighted the importance of whole-house generator systems, which have become a standard residential electrical scope in Portland.`,
    panelAndCodePara: `City of Portland Bureau of Development Services handles electrical permits. Oregon CCB license required; verify at ccb.oregon.gov. Portland homes in Pearl District and Lake Oswego show distinct housing-era electrical profiles: pre-1965 construction may have aluminum branch wiring or Federal Pacific Stab-Lok panels (documented fire hazards), while post-2000 construction typically has 200-amp service with AFCI protection on bedroom circuits. EV charger installation is the fastest-growing residential electrical scope in Portland, with Level 2 (240V, 40-amp) installations running $1,400-$3,500 depending on panel capacity and circuit length.`,
    safetyAndLicensePara: `Irvington, Ladd's Addition, Piedmont, and Lair Hill historic districts are under the Portland Historic Landmarks Commission; visible exterior electrical work on contributing structures may require preservation commission review. Oregon requires biennial DEQ emissions testing in the Portland metro area. Federal Pacific Stab-Lok panels and Zinsco panels are documented fire hazards found in 1960s-1970s Portland homes; replacement with modern Siemens, Square D, or Eaton panels is a safety-critical upgrade. Portland State University, Reed College, and Lewis & Clark College area properties in Pearl District may have rental-grade electrical systems that need upgrading for owner-occupancy.`,
  },
  "sacramento-ca": {
    localUtilityPara: `SMUD serves the Sacramento metro with residential service coordination for panel upgrades typically running 10-20 business days. PG&E handles gas service where applicable. Sacramento's housing stock across East Sacramento and Midtown spans construction eras from pre-war to modern, with corresponding electrical infrastructure ranging from 60-amp fuse panels to modern 200-amp breaker service. The January 2023 atmospheric river sequence that produced record flooding across the Sacramento Valley highlighted the importance of whole-house generator systems, which have become a standard residential electrical scope in Sacramento.`,
    panelAndCodePara: `City of Sacramento Community Development handles electrical permits. California requires specific contractor licenses through CSLB; verify at cslb.ca.gov. Sacramento homes in East Sacramento and Elk Grove show distinct housing-era electrical profiles: pre-1965 construction may have aluminum branch wiring or Federal Pacific Stab-Lok panels (documented fire hazards), while post-2000 construction typically has 200-amp service with AFCI protection on bedroom circuits. EV charger installation is the fastest-growing residential electrical scope in Sacramento, with Level 2 (240V, 40-amp) installations running $1,400-$3,500 depending on panel capacity and circuit length.`,
    safetyAndLicensePara: `Alkali Flat, Boulevard Park, and Poverty Ridge are under the Sacramento Preservation Commission; visible exterior electrical work on contributing structures may require preservation commission review. California requires biennial smog checks through the BAR for vehicles over 8 model years. Federal Pacific Stab-Lok panels and Zinsco panels are documented fire hazards found in 1960s-1970s Sacramento homes; replacement with modern Siemens, Square D, or Eaton panels is a safety-critical upgrade. UC Davis, Sacramento State, and McGeorge School of Law area properties in East Sacramento may have rental-grade electrical systems that need upgrading for owner-occupancy.`,
  },
  "pittsburgh-pa": {
    localUtilityPara: `Duquesne Light serves the Pittsburgh metro with residential service coordination for panel upgrades typically running 10-20 business days. Peoples Gas handles gas service where applicable. Pittsburgh's housing stock across Shadyside and Squirrel Hill spans construction eras from pre-war to modern, with corresponding electrical infrastructure ranging from 60-amp fuse panels to modern 200-amp breaker service. The June 2012 derecho and the August 2019 windstorm that produced widespread damage across Allegheny County highlighted the importance of whole-house generator systems, which have become a standard residential electrical scope in Pittsburgh.`,
    panelAndCodePara: `City of Pittsburgh PLI handles electrical permits. Pennsylvania requires HIC registration under Act 132; verify at pago.state.pa.us. Pittsburgh homes in Shadyside and Lawrenceville show distinct housing-era electrical profiles: pre-1965 construction may have aluminum branch wiring or Federal Pacific Stab-Lok panels (documented fire hazards), while post-2000 construction typically has 200-amp service with AFCI protection on bedroom circuits. EV charger installation is the fastest-growing residential electrical scope in Pittsburgh, with Level 2 (240V, 40-amp) installations running $1,400-$3,500 depending on panel capacity and circuit length.`,
    safetyAndLicensePara: `Allegheny West, Manchester, Mexican War Streets, and Deutschtown are under the Pittsburgh Historic Review Commission; visible exterior electrical work on contributing structures may require preservation commission review. Pennsylvania requires annual safety inspection and biennial emissions testing through PennDOT. Federal Pacific Stab-Lok panels and Zinsco panels are documented fire hazards found in 1960s-1970s Pittsburgh homes; replacement with modern Siemens, Square D, or Eaton panels is a safety-critical upgrade. University of Pittsburgh and Carnegie Mellon University area properties in Shadyside may have rental-grade electrical systems that need upgrading for owner-occupancy.`,
  },
  "columbus-oh": {
    localUtilityPara: `AEP Ohio serves the Columbus metro with residential service coordination for panel upgrades typically running 10-20 business days. Columbia Gas of Ohio handles gas service where applicable. Columbus's housing stock across German Village and Short North spans construction eras from pre-war to modern, with corresponding electrical infrastructure ranging from 60-amp fuse panels to modern 200-amp breaker service. The June 2012 derecho that produced widespread power outages and property damage across Franklin County highlighted the importance of whole-house generator systems, which have become a standard residential electrical scope in Columbus.`,
    panelAndCodePara: `City of Columbus Building and Zoning Services handles electrical permits. Ohio has no statewide residential contractor license; Columbus requires local registration. Columbus homes in German Village and Upper Arlington show distinct housing-era electrical profiles: pre-1965 construction may have aluminum branch wiring or Federal Pacific Stab-Lok panels (documented fire hazards), while post-2000 construction typically has 200-amp service with AFCI protection on bedroom circuits. EV charger installation is the fastest-growing residential electrical scope in Columbus, with Level 2 (240V, 40-amp) installations running $1,400-$3,500 depending on panel capacity and circuit length.`,
    safetyAndLicensePara: `German Village, Victorian Village, and Italian Village are under the Columbus Historic Preservation Commission; visible exterior electrical work on contributing structures may require preservation commission review. Ohio eliminated E-Check emissions testing; no state vehicle inspection requirement exists. Federal Pacific Stab-Lok panels and Zinsco panels are documented fire hazards found in 1960s-1970s Columbus homes; replacement with modern Siemens, Square D, or Eaton panels is a safety-critical upgrade. The Ohio State University, Capital University, and Otterbein University area properties in German Village may have rental-grade electrical systems that need upgrading for owner-occupancy.`,
  },
  "kansas-city-mo": {
    localUtilityPara: `Evergy serves the Kansas City metro with residential service coordination for panel upgrades typically running 10-20 business days. Spire handles gas service where applicable. Kansas City's housing stock across Country Club Plaza and Brookside spans construction eras from pre-war to modern, with corresponding electrical infrastructure ranging from 60-amp fuse panels to modern 200-amp breaker service. The May 2024 supercell hail event that produced widespread damage across Johnson County KS and the March 2022 tornado outbreak highlighted the importance of whole-house generator systems, which have become a standard residential electrical scope in Kansas City.`,
    panelAndCodePara: `Kansas City Permits and Inspections handles electrical permits. Missouri has no statewide roofer license; Kansas requires contractor registration through the Attorney General. The metro straddles both states. Kansas City homes in Country Club Plaza and Overland Park show distinct housing-era electrical profiles: pre-1965 construction may have aluminum branch wiring or Federal Pacific Stab-Lok panels (documented fire hazards), while post-2000 construction typically has 200-amp service with AFCI protection on bedroom circuits. EV charger installation is the fastest-growing residential electrical scope in Kansas City, with Level 2 (240V, 40-amp) installations running $1,400-$3,500 depending on panel capacity and circuit length.`,
    safetyAndLicensePara: `Country Club Plaza, Pendleton Heights, and Janssen Place are under the KCMO Historic Preservation Commission; Kansas-side municipalities have limited historic protections; visible exterior electrical work on contributing structures may require preservation commission review. Missouri requires emissions testing in the KC metro; Kansas does not require vehicle inspections. Federal Pacific Stab-Lok panels and Zinsco panels are documented fire hazards found in 1960s-1970s Kansas City homes; replacement with modern Siemens, Square D, or Eaton panels is a safety-critical upgrade. UMKC, University of Kansas (Lawrence), and Rockhurst University area properties in Country Club Plaza may have rental-grade electrical systems that need upgrading for owner-occupancy.`,
  },
  "indianapolis-in": {
    localUtilityPara: `AES Indiana serves the Indianapolis metro with residential service coordination for panel upgrades typically running 10-20 business days. CenterPoint Energy Indiana handles gas service where applicable. Indianapolis's housing stock across Broad Ripple and Meridian-Kessler spans construction eras from pre-war to modern, with corresponding electrical infrastructure ranging from 60-amp fuse panels to modern 200-amp breaker service. The November 2013 EF2 tornado in Washington Township and the April 2023 spring hail event that damaged thousands of homes highlighted the importance of whole-house generator systems, which have become a standard residential electrical scope in Indianapolis.`,
    panelAndCodePara: `Indianapolis Department of Business and Neighborhood Services handles electrical permits. Indiana has no statewide residential contractor license but requires Marion County registration. Indianapolis homes in Broad Ripple and Carmel show distinct housing-era electrical profiles: pre-1965 construction may have aluminum branch wiring or Federal Pacific Stab-Lok panels (documented fire hazards), while post-2000 construction typically has 200-amp service with AFCI protection on bedroom circuits. EV charger installation is the fastest-growing residential electrical scope in Indianapolis, with Level 2 (240V, 40-amp) installations running $1,400-$3,500 depending on panel capacity and circuit length.`,
    safetyAndLicensePara: `Irvington, Lockerbie Square, Woodruff Place, and Herron-Morton Place are under the Indianapolis Historic Preservation Commission; visible exterior electrical work on contributing structures may require preservation commission review. Indiana does not require vehicle safety inspections or emissions testing. Federal Pacific Stab-Lok panels and Zinsco panels are documented fire hazards found in 1960s-1970s Indianapolis homes; replacement with modern Siemens, Square D, or Eaton panels is a safety-critical upgrade. Indiana University-Purdue University Indianapolis (IUPUI), Butler University, and Marian University area properties in Broad Ripple may have rental-grade electrical systems that need upgrading for owner-occupancy.`,
  },
  "nashville-tn": {
    localUtilityPara: `Nashville Electric Service (NES) serves the Nashville metro with residential service coordination for panel upgrades typically running 10-20 business days. Piedmont Natural Gas handles gas service where applicable. Nashville's housing stock across East Nashville and 12South spans construction eras from pre-war to modern, with corresponding electrical infrastructure ranging from 60-amp fuse panels to modern 200-amp breaker service. The March 2020 EF3 tornado that devastated East Nashville, Germantown, Donelson, and Mt. Juliet highlighted the importance of whole-house generator systems, which have become a standard residential electrical scope in Nashville.`,
    panelAndCodePara: `Metro Nashville Department of Codes Administration handles electrical permits. Tennessee requires a Home Improvement License for projects over $3,000 through the Tennessee Board for Licensing Contractors. Nashville homes in East Nashville and Green Hills show distinct housing-era electrical profiles: pre-1965 construction may have aluminum branch wiring or Federal Pacific Stab-Lok panels (documented fire hazards), while post-2000 construction typically has 200-amp service with AFCI protection on bedroom circuits. EV charger installation is the fastest-growing residential electrical scope in Nashville, with Level 2 (240V, 40-amp) installations running $1,400-$3,500 depending on panel capacity and circuit length.`,
    safetyAndLicensePara: `East Nashville, Germantown, and Lockeland Springs are under the Metro Nashville Historic Zoning Commission; visible exterior electrical work on contributing structures may require preservation commission review. Tennessee requires annual emissions testing in Davidson County for vehicles 3-25 model years old. Federal Pacific Stab-Lok panels and Zinsco panels are documented fire hazards found in 1960s-1970s Nashville homes; replacement with modern Siemens, Square D, or Eaton panels is a safety-critical upgrade. Vanderbilt University, Belmont University, and Tennessee State University area properties in East Nashville may have rental-grade electrical systems that need upgrading for owner-occupancy.`,
  },
};
