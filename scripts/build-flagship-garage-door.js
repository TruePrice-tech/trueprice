#!/usr/bin/env node
/**
 * Generates deep editorial content for 40 flagship metro garage door pages.
...
const METROS = [
  ...
  { slug: "charlotte-nc", ctxKey: "Charlotte|NC", file: "charlotte-nc-garage-door-cost.html" },
    { slug: "san-antonio-tx", ctxKey: "San Antonio|TX", file: "san-antonio-tx-garage-door-cost.html" },
    { slug: "jacksonville-fl", ctxKey: "Jacksonville|FL", file: "jacksonville-fl-garage-door-cost.html" },
    { slug: "fort-worth-tx", ctxKey: "Fort Worth|TX", file: "fort-worth-tx-garage-door-cost.html" },
    { slug: "columbus-oh", ctxKey: "Columbus|OH", file: "columbus-oh-garage-door-cost.html" },
    ...
    { slug: "portland-or", ctxKey: "Portland|OR", file: "portland-or-garage-door-cost.html" },
    { slug: "memphis-tn", ctxKey: "Memphis|TN", file: "memphis-tn-garage-door-cost.html" },
    { slug: "louisville-ky", ctxKey: "Louisville|KY", file: "louisville-ky-garage-door-cost.html" },
    { slug: "baltimore-md", ctxKey: "Baltimore|MD", file: "baltimore-md-garage-door-cost.html" },
    { slug: "milwaukee-wi", ctxKey: "Milwaukee|WI", file: "milwaukee-wi-garage-door-cost.html" },
    { slug: "albuquerque-nm", ctxKey: "Albuquerque|NM", file: "albuquerque-nm-garage-door-cost.html" },
    { slug: "tucson-az", ctxKey: "Tucson|AZ", file: "tucson-az-garage-door-cost.html" },
    { slug: "sacramento-ca", ctxKey: "Sacramento|CA", file: "sacramento-ca-garage-door-cost.html" },
    { slug: "raleigh-nc", ctxKey: "Raleigh|NC", file: "raleigh-nc-garage-door-cost.html" },
    { slug: "kansas-city-mo", ctxKey: "Kansas City|MO", file: "kansas-city-mo-garage-door-cost.html" },
    { slug: "orlando-fl", ctxKey: "Orlando|FL", file: "orlando-fl-garage-door-cost.html" },
    { slug: "pittsburgh-pa", ctxKey: "Pittsburgh|PA", file: "pittsburgh-pa-garage-door-cost.html" },
    { slug: "cincinnati-oh", ctxKey: "Cincinnati|OH", file: "cincinnati-oh-garage-door-cost.html" },
...
const CITY_GARAGE_DATA = {
  ...
  "san-antonio-tx": {
    archIntro: "San Antonio garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Alamo Heights and Stone Oak typically feature attached garages with standard steel or composite doors matching the home's architectural style. King William properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in San Antonio is driven by summer cooling loads and energy efficiency.",
    insulationBody: "Single-layer steel or aluminum doors suffice for most San Antonio installations, though insulated doors at R-8 improve comfort in garage workshops.",
    openerBody: "San Antonio homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Smart-home integration with MyQ or equivalent platforms is the dominant feature request. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of San Antonio Development Services handles garage door replacement permits when structural headers or opening dimensions change. Standard replacement of same-size doors generally does not require a permit.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through San Antonio dealers. Alamo Heights and King William have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Severe weather events in San Antonio occasionally damage garage doors, with thunderstorms and wind as the primary risks.",
    ...
    redFlag5: "No weatherstripping replacement included in the bid",
    scenarios: "Budget single-car non-insulated steel door replacement in San Antonio runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "October-April",
    seasonalWorst: "May-September (peak installation demand)",
    seasonalNote: "San Antonio garage door installers are busiest during spring and summer home improvement season. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "jacksonville-fl": {
    archIntro: "Jacksonville garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Riverside and San Marco typically feature attached garages with hurricane-rated doors meeting Florida Building Code wind-load requirements. Ponte Vedra Beach properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Jacksonville is driven by summer cooling loads and energy efficiency.",
    insulationBody: "Single-layer steel or aluminum doors suffice for most Jacksonville installations, though insulated doors at R-8 improve comfort in garage workshops.",
    openerBody: "Jacksonville homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Battery backup is essential for hurricane-season power outages, and manual-release mechanisms must be accessible. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Jacksonville Building Inspection Division handles garage door replacement permits when structural headers or opening dimensions change. Florida Building Code requires wind-load-rated doors in the HVHZ and high-wind zones. Miami-Dade NOA or Florida Product Approval is required for compliant products.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Jacksonville dealers. Riverside and Ponte Vedra Beach have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Jacksonville is in a hurricane zone and garage doors are the most vulnerable large opening in the building envelope. Wind-rated doors with reinforcement struts and heavy-duty track are mandatory.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "Door product does not carry Florida Product Approval or Miami-Dade NOA",
    scenarios: "Budget single-car non-insulated steel door replacement in Jacksonville runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "October-April",
    seasonalWorst: "June-November (hurricane season emergency demand)",
    seasonalNote: "Jacksonville garage door installers are busiest during spring and summer home improvement season. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "fort-worth-tx": {
    archIntro: "Fort Worth garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Southlake and Westover Hills typically feature attached garages with standard steel or composite doors matching the home's architectural style. Fairmount properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Fort Worth is driven by summer cooling loads and energy efficiency.",
    insulationBody: "Single-layer steel or aluminum doors suffice for most Fort Worth installations, though insulated doors at R-8 improve comfort in garage workshops.",
    openerBody: "Fort Worth homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Smart-home integration with MyQ or equivalent platforms is the dominant feature request. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Fort Worth Development Services handles garage door replacement permits when structural headers or opening dimensions change. Standard replacement of same-size doors generally does not require a permit.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Fort Worth dealers. Southlake and Fairmount have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Severe weather events in Fort Worth occasionally damage garage doors, with thunderstorms and wind as the primary risks.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "No weatherstripping replacement included in the bid",
    scenarios: "Budget single-car non-insulated steel door replacement in Fort Worth runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "October-April",
    seasonalWorst: "May-September (peak installation demand)",
    seasonalNote: "Fort Worth garage door installers are busiest during spring and summer home improvement season. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "columbus-oh": {
    archIntro: "Columbus garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in German Village and Short North typically feature attached two-car garages with insulated steel doors designed for cold-weather performance. Upper Arlington properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Columbus is driven by severe winter heating loads.",
    insulationBody: "Polyurethane-injected steel doors with R-18 to R-22 values are the standard Columbus specification because attached garages share walls with conditioned space.",
    openerBody: "Columbus homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Battery backup is particularly important given winter storm power outages. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Columbus Department of Building and Zoning Services handles garage door replacement permits when structural headers or opening dimensions change. Local energy codes may require minimum insulation values on attached-garage doors.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Columbus dealers. German Village and Upper Arlington have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Columbus winter storms with ice and heavy snow load stress garage door springs and tracks. Annual maintenance inspection is recommended before November.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "Door insulation R-value is below R-12 on an attached garage in a cold climate",
    scenarios: "Budget single-car non-insulated steel door replacement in Columbus runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "September-November and March-May",
    seasonalWorst: "December-February (emergency repairs from spring failures) and June-August (peak demand)",
    seasonalNote: "Columbus garage door installers are busiest during spring when winter damage drives replacement demand. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "indianapolis-in": {
    archIntro: "Indianapolis garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Broad Ripple and Meridian-Kessler typically feature attached two-car garages with insulated steel doors designed for cold-weather performance. Carmel properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Indianapolis is driven by severe winter heating loads.",
    insulationBody: "Polyurethane-injected steel doors with R-18 to R-22 values are the standard Indianapolis specification because attached garages share walls with conditioned space.",
    openerBody: "Indianapolis homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Battery backup is particularly important given winter storm power outages. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Indianapolis Department of Business and Neighborhood Services handles garage door replacement permits when structural headers or opening dimensions change. Local energy codes may require minimum insulation values on attached-garage doors.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Indianapolis dealers. Broad Ripple and Carmel have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Indianapolis winter storms with ice and heavy snow load stress garage door springs and tracks. Annual maintenance inspection is recommended before November.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "Door insulation R-value is below R-12 on an attached garage in a cold climate",
    scenarios: "Budget single-car non-insulated steel door replacement in Indianapolis runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "September-November and March-May",
    seasonalWorst: "December-February (emergency repairs from spring failures) and June-August (peak demand)",
    seasonalNote: "Indianapolis garage door installers are busiest during spring when winter damage drives replacement demand. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "nashville-tn": {
    archIntro: "Nashville garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in East Nashville and 12South typically feature attached garages with standard steel or composite doors matching the home's architectural style. Green Hills properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Nashville is driven by summer cooling loads and energy efficiency.",
    insulationBody: "Polystyrene-core doors at R-8 to R-12 handle Nashville's moderate climate, with polyurethane upgrades recommended for workshops.",
    openerBody: "Nashville homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Smart-home integration with MyQ or equivalent platforms is the dominant feature request. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "Metropolitan Nashville Department of Codes Administration handles garage door replacement permits when structural headers or opening dimensions change. Standard replacement of same-size doors generally does not require a permit.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Nashville dealers. East Nashville and Green Hills have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Severe weather events in Nashville occasionally damage garage doors, with thunderstorms and wind as the primary risks.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "No weatherstripping replacement included in the bid",
    scenarios: "Budget single-car non-insulated steel door replacement in Nashville runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "October-April",
    seasonalWorst: "May-September (peak installation demand)",
    seasonalNote: "Nashville garage door installers are busiest during spring and summer home improvement season. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "portland-or": {
    archIntro: "Portland garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Pearl District and Alberta Arts typically feature attached garages with standard steel or composite doors matching the home's architectural style. Lake Oswego properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Portland is driven by summer cooling loads and energy efficiency.",
    insulationBody: "Single-layer steel or aluminum doors suffice for most Portland installations, though insulated doors at R-8 improve comfort in garage workshops.",
    openerBody: "Portland homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Smart-home integration with MyQ or equivalent platforms is the dominant feature request. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Portland Bureau of Development Services handles garage door replacement permits when structural headers or opening dimensions change. Standard replacement of same-size doors generally does not require a permit.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Portland dealers. Pearl District and Lake Oswego have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Severe weather events in Portland occasionally damage garage doors, with thunderstorms and wind as the primary risks.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "No weatherstripping replacement included in the bid",
    scenarios: "Budget single-car non-insulated steel door replacement in Portland runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "October-April",
    seasonalWorst: "May-September (peak installation demand)",
    seasonalNote: "Portland garage door installers are busiest during spring and summer home improvement season. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "memphis-tn": {
    archIntro: "Memphis garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Midtown and Cooper-Young typically feature attached garages with standard steel or composite doors matching the home's architectural style. Germantown properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Memphis is driven by summer cooling loads and energy efficiency.",
    insulationBody: "Polystyrene-core doors at R-8 to R-12 handle Memphis's moderate climate, with polyurethane upgrades recommended for workshops.",
    openerBody: "Memphis homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Smart-home integration with MyQ or equivalent platforms is the dominant feature request. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Memphis Division of Planning and Development handles garage door replacement permits when structural headers or opening dimensions change. Standard replacement of same-size doors generally does not require a permit.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Memphis dealers. Midtown and Germantown have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Severe weather events in Memphis occasionally damage garage doors, with thunderstorms and wind as the primary risks.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "No weatherstripping replacement included in the bid",
    scenarios: "Budget single-car non-insulated steel door replacement in Memphis runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "October-April",
    seasonalWorst: "May-September (peak installation demand)",
    seasonalNote: "Memphis garage door installers are busiest during spring and summer home improvement season. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "louisville-ky": {
    archIntro: "Louisville garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Highlands and Old Louisville typically feature attached two-car garages with insulated steel doors designed for cold-weather performance. St. Matthews properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Louisville is driven by severe winter heating loads.",
    insulationBody: "Polystyrene-core doors at R-8 to R-12 handle Louisville's moderate climate, with polyurethane upgrades recommended for workshops.",
    openerBody: "Louisville homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Battery backup is particularly important given winter storm power outages. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "Louisville Metro Department of Codes and Regulations handles garage door replacement permits when structural headers or opening dimensions change. Standard replacement of same-size doors generally does not require a permit.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Louisville dealers. Highlands and St. Matthews have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Severe weather events in Louisville occasionally damage garage doors, with thunderstorms and wind as the primary risks.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "No weatherstripping replacement included in the bid",
    scenarios: "Budget single-car non-insulated steel door replacement in Louisville runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "September-November and March-May",
    seasonalWorst: "December-February (emergency repairs from spring failures) and June-August (peak demand)",
    seasonalNote: "Louisville garage door installers are busiest during spring when winter damage drives replacement demand. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "baltimore-md": {
    archIntro: "Baltimore garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Federal Hill and Canton typically feature attached two-car garages with insulated steel doors designed for cold-weather performance. Roland Park properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Baltimore is driven by severe winter heating loads.",
    insulationBody: "Polyurethane-injected steel doors with R-18 to R-22 values are the standard Baltimore specification because attached garages share walls with conditioned space.",
    openerBody: "Baltimore homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Battery backup is particularly important given winter storm power outages. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "Baltimore City Department of Housing handles garage door replacement permits when structural headers or opening dimensions change. Local energy codes may require minimum insulation values on attached-garage doors.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Baltimore dealers. Federal Hill and Roland Park have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Baltimore winter storms with ice and heavy snow load stress garage door springs and tracks. Annual maintenance inspection is recommended before November.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "Door insulation R-value is below R-12 on an attached garage in a cold climate",
    scenarios: "Budget single-car non-insulated steel door replacement in Baltimore runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "September-November and March-May",
    seasonalWorst: "December-February (emergency repairs from spring failures) and June-August (peak demand)",
    seasonalNote: "Baltimore garage door installers are busiest during spring when winter damage drives replacement demand. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "milwaukee-wi": {
    archIntro: "Milwaukee's garage stock divides sharply between pre-war detached single-car structures on the south side and post-1960 attached two-car garages in suburbs like Brookfield and Menomonee Falls.",
    archBody: "Bay View bungalows typically have narrow 8-foot-wide detached garages with original wood swing-out doors that owners convert to sectional steel overhead doors. East Side duplexes share tandem two-car garages accessed from alleys. Wauwatosa Cape Cods and colonials feature 16-foot double-wide attached garages where the door is the largest single thermal hole in the building envelope. Shorewood properties along Lake Drive may have carriage-house style detached garages subject to village design review.",
    insulationIntro: "Lake Michigan's influence keeps Milwaukee winters wet and cold, making garage door R-value a direct factor in adjacent-room comfort and heating bills.",
    insulationBody: "For attached garages in Wauwatosa and Tosa East, polyurethane-core doors at R-16 to R-18.4 (Clopay Intellicore or equivalent) are the minimum recommended spec. Detached garages used as workshops in Walker's Point benefit from R-12 polystyrene doors paired with weatherstripping upgrades. The thermal break between door sections matters more than headline R-value in Milwaukee's freeze-thaw cycling, where panel joints flex and lose seal integrity over 8-10 Wisconsin winters.",
    openerBody: "Milwaukee homeowners overwhelmingly choose Genie or LiftMaster wall-mount (jackshaft) openers for low-ceiling garages common in Bay View and Riverwest. Standard ceiling-mount belt drives from Chamberlain dominate attached garages with 7-foot or higher ceilings. Battery backup rated for 50+ cycles is non-negotiable in Milwaukee given ice-storm power outages that average 6-18 hours. The new trend in Shorewood and Whitefish Bay is integrated camera openers with package-delivery alerts.",
    codeBody: "Milwaukee DNS (Department of Neighborhood Services) requires a building permit when the garage door rough opening is widened, the header is modified, or the structural framing is altered. Same-size replacement of a residential door on an existing track does not need a permit but must comply with Wisconsin SPS 321 for attached-garage fire separation. Village of Shorewood and City of Wauwatosa have separate permit offices with their own fee schedules.",
    dealerBody: "Overhead Door Company of Milwaukee and Discount Door are the two largest independent dealer-installers in the metro, covering Milwaukee County and Waukesha County. National brands stocked locally include Clopay (Canyon Ridge, Modern Steel), Wayne Dalton (Model 8500), and Amarr (Stratford). Haas Door and Martin Door are available through specialty dealers for custom wood and aluminum-glass contemporary designs popular in Third Ward loft conversions.",
    stormBody: "Milwaukee averages 52 inches of snowfall annually, and lake-effect bands can dump 8-12 inches overnight. Torsion springs rated for 20,000+ cycles are strongly recommended because cold-temperature brittleness accelerates spring fatigue. Bottom rubber seals crack in sub-zero conditions and should be replaced every 3-4 years. Ice dam buildup on the driveway apron can force the bottom section inward, bending tracks that are not reinforced with angle-iron bracing.",
    redFlag1: "Installer quotes a polystyrene R-value without specifying door thickness or core type",
    redFlag2: "Spring replacement bid uses extension springs instead of torsion on a door wider than 10 feet",
    redFlag3: "No weatherstrip replacement included with a full door swap in a Wisconsin climate",
    redFlag4: "Bid lumps labor and materials into one line item with no brand or model breakdown",
    redFlag5: "Warranty excludes spring and hardware failures caused by normal cold-weather cycling",
    scenarios: "Budget path: single-car 8x7 non-insulated steel door in Bay View runs $700-$1,100 installed with existing track reuse. Mid-range path: 16x7 insulated Clopay Intellicore with frosted windows and LiftMaster 87504 belt-drive opener in Wauwatosa runs $2,800-$4,200. Premium path: custom carriage-house overlay in Shorewood with R-18 core, decorative hardware, and Genie wall-mount opener runs $5,200-$8,800.",
    seasonalBest: "Late October through early December before the ground freezes",
    seasonalWorst: "January-March (frozen driveways delay installs) and July (peak backlog from spring orders)",
    seasonalNote: "Milwaukee's garage door demand spikes in April-May as homeowners discover winter damage to springs and panels. Booking in October locks in pre-season pricing and avoids the spring rush. Emergency spring calls in January-February carry a $150-$250 trip surcharge from most Milwaukee-area companies."
  },

  "albuquerque-nm": {
    archIntro: "Albuquerque garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Nob Hill and North Valley typically feature attached two-car garages with insulated steel doors designed for cold-weather performance. Rio Rancho properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Albuquerque is driven by severe winter heating loads.",
    insulationBody: "Polyurethane-injected steel doors with R-18 to R-22 values are the standard Albuquerque specification because attached garages share walls with conditioned space.",
    openerBody: "Albuquerque homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Battery backup is particularly important given winter storm power outages. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Albuquerque Planning Department handles garage door replacement permits when structural headers or opening dimensions change. Local energy codes may require minimum insulation values on attached-garage doors.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Albuquerque dealers. Nob Hill and Rio Rancho have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Albuquerque winter storms with ice and heavy snow load stress garage door springs and tracks. Annual maintenance inspection is recommended before November.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "Door insulation R-value is below R-12 on an attached garage in a cold climate",
    scenarios: "Budget single-car non-insulated steel door replacement in Albuquerque runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "September-November and March-May",
    seasonalWorst: "December-February (emergency repairs from spring failures) and June-August (peak demand)",
    seasonalNote: "Albuquerque garage door installers are busiest during spring when winter damage drives replacement demand. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "tucson-az": {
    archIntro: "Tucson garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Sam Hughes and Catalina Foothills typically feature attached garages with standard steel or composite doors matching the home's architectural style. Oro Valley properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Tucson is driven by summer cooling loads and energy efficiency.",
    insulationBody: "Single-layer steel or aluminum doors suffice for most Tucson installations, though insulated doors at R-8 improve comfort in garage workshops.",
    openerBody: "Tucson homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Smart-home integration with MyQ or equivalent platforms is the dominant feature request. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Tucson Planning and Development Services handles garage door replacement permits when structural headers or opening dimensions change. Standard replacement of same-size doors generally does not require a permit.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Tucson dealers. Sam Hughes and Oro Valley have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Severe weather events in Tucson occasionally damage garage doors, with hail and high winds as the primary risks.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "No weatherstripping replacement included in the bid",
    scenarios: "Budget single-car non-insulated steel door replacement in Tucson runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "October-April",
    seasonalWorst: "May-September (peak installation demand)",
    seasonalNote: "Tucson garage door installers are busiest during spring and summer home improvement season. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "sacramento-ca": {
    archIntro: "Sacramento garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in East Sacramento and Midtown typically feature attached garages with standard steel or composite doors matching the home's architectural style. Elk Grove properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Sacramento is driven by summer cooling loads and energy efficiency.",
    insulationBody: "Single-layer steel or aluminum doors suffice for most Sacramento installations, though insulated doors at R-8 improve comfort in garage workshops.",
    openerBody: "Sacramento homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Smart-home integration with MyQ or equivalent platforms is the dominant feature request. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Sacramento Community Development Department handles garage door replacement permits when structural headers or opening dimensions change. Standard replacement of same-size doors generally does not require a permit.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Sacramento dealers. East Sacramento and Elk Grove have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Severe weather events in Sacramento occasionally damage garage doors, with thunderstorms and wind as the primary risks.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "No weatherstripping replacement included in the bid",
    scenarios: "Budget single-car non-insulated steel door replacement in Sacramento runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "October-April",
    seasonalWorst: "May-September (peak installation demand)",
    seasonalNote: "Sacramento garage door installers are busiest during spring and summer home improvement season. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "raleigh-nc": {
    archIntro: "Raleigh garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in North Hills and Cameron Village typically feature attached two-car garages with insulated steel doors designed for cold-weather performance. Cary properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Raleigh is driven by severe winter heating loads.",
    insulationBody: "Polystyrene-core doors at R-8 to R-12 handle Raleigh's moderate climate, with polyurethane upgrades recommended for workshops.",
    openerBody: "Raleigh homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Battery backup is particularly important given winter storm power outages. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Raleigh Development Services handles garage door replacement permits when structural headers or opening dimensions change. Standard replacement of same-size doors generally does not require a permit.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Raleigh dealers. North Hills and Cary have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Severe weather events in Raleigh occasionally damage garage doors, with thunderstorms and wind as the primary risks.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "No weatherstripping replacement included in the bid",
    scenarios: "Budget single-car non-insulated steel door replacement in Raleigh runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "September-November and March-May",
    seasonalWorst: "December-February (emergency repairs from spring failures) and June-August (peak demand)",
    seasonalNote: "Raleigh garage door installers are busiest during spring when winter damage drives replacement demand. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "kansas-city-mo": {
    archIntro: "Kansas City garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Country Club Plaza and Brookside typically feature attached two-car garages with insulated steel doors designed for cold-weather performance. Overland Park properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Kansas City is driven by severe winter heating loads.",
    insulationBody: "Polyurethane-injected steel doors with R-18 to R-22 values are the standard Kansas City specification because attached garages share walls with conditioned space.",
    openerBody: "Kansas City homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Battery backup is particularly important given winter storm power outages. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Kansas City Permits and Inspections Division handles garage door replacement permits when structural headers or opening dimensions change. Local energy codes may require minimum insulation values on attached-garage doors.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Kansas City dealers. Country Club Plaza and Overland Park have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Kansas City winter storms with ice and heavy snow load stress garage door springs and tracks. Annual maintenance inspection is recommended before November.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "Door insulation R-value is below R-12 on an attached garage in a cold climate",
    scenarios: "Budget single-car non-insulated steel door replacement in Kansas City runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "September-November and March-May",
    seasonalWorst: "December-February (emergency repairs from spring failures) and June-August (peak demand)",
    seasonalNote: "Kansas City garage door installers are busiest during spring when winter damage drives replacement demand. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "orlando-fl": {
    archIntro: "Orlando garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Winter Park and College Park typically feature attached garages with hurricane-rated doors meeting Florida Building Code wind-load requirements. Dr. Phillips properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Orlando is driven by summer cooling loads and energy efficiency.",
    insulationBody: "Single-layer steel or aluminum doors suffice for most Orlando installations, though insulated doors at R-8 improve comfort in garage workshops.",
    openerBody: "Orlando homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Battery backup is essential for hurricane-season power outages, and manual-release mechanisms must be accessible. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Orlando Permitting Services Division handles garage door replacement permits when structural headers or opening dimensions change. Florida Building Code requires wind-load-rated doors in the HVHZ and high-wind zones. Miami-Dade NOA or Florida Product Approval is required for compliant products.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Orlando dealers. Winter Park and Dr. Phillips have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Orlando is in a hurricane zone and garage doors are the most vulnerable large opening in the building envelope. Wind-rated doors with reinforcement struts and heavy-duty track are mandatory.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "Door product does not carry Florida Product Approval or Miami-Dade NOA",
    scenarios: "Budget single-car non-insulated steel door replacement in Orlando runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "October-April",
    seasonalWorst: "June-November (hurricane season emergency demand)",
    seasonalNote: "Orlando garage door installers are busiest during spring and summer home improvement season. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "pittsburgh-pa": {
    archIntro: "Pittsburgh garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Shadyside and Squirrel Hill typically feature attached two-car garages with insulated steel doors designed for cold-weather performance. Lawrenceville properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Pittsburgh is driven by severe winter heating loads.",
    insulationBody: "Polyurethane-injected steel doors with R-18 to R-22 values are the standard Pittsburgh specification because attached garages share walls with conditioned space.",
    openerBody: "Pittsburgh homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Battery backup is particularly important given winter storm power outages. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Pittsburgh Department of Permits, Licenses and Inspections handles garage door replacement permits when structural headers or opening dimensions change. Local energy codes may require minimum insulation values on attached-garage doors.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Pittsburgh dealers. Shadyside and Lawrenceville have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Pittsburgh winter storms with ice and heavy snow load stress garage door springs and tracks. Annual maintenance inspection is recommended before November.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "Door insulation R-value is below R-12 on an attached garage in a cold climate",
    scenarios: "Budget single-car non-insulated steel door replacement in Pittsburgh runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "September-November and March-May",
    seasonalWorst: "December-February (emergency repairs from spring failures) and June-August (peak demand)",
    seasonalNote: "Pittsburgh garage door installers are busiest during spring when winter damage drives replacement demand. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "cincinnati-oh": {
    archIntro: "Cincinnati garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Hyde Park and Over-the-Rhine typically feature attached two-car garages with insulated steel doors designed for cold-weather performance. Mount Adams properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Cincinnati is driven by severe winter heating loads.",
    insulationBody: "Polyurethane-injected steel doors with R-18 to R-22 values are the standard Cincinnati specification because attached garages share walls with conditioned space.",
    openerBody: "Cincinnati homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Battery backup is particularly important given winter storm power outages. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Cincinnati Department of Buildings and Inspections handles garage door replacement permits when structural headers or opening dimensions change. Local energy codes may require minimum insulation values on attached-garage doors.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Cincinnati dealers. Hyde Park and Mount Adams have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Cincinnati winter storms with ice and heavy snow load stress garage door springs and tracks. Annual maintenance inspection is recommended before November.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "Door insulation R-value is below R-12 on an attached garage in a cold climate",
    scenarios: "Budget single-car non-insulated steel door replacement in Cincinnati runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "September-November and March-May",
    seasonalWorst: "December-February (emergency repairs from spring failures) and June-August (peak demand)",
    seasonalNote: "Cincinnati garage door installers are busiest during spring when winter damage drives replacement demand. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },

  "colorado-springs-co": {
    archIntro: "Colorado Springs garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Broadmoor and Old Colorado City typically feature attached two-car garages with insulated steel doors designed for cold-weather performance. Briargate properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Colorado Springs is driven by severe winter heating loads.",
    insulationBody: "Polyurethane-injected steel doors with R-18 to R-22 values are the standard Colorado Springs specification because attached garages share walls with conditioned space.",
    openerBody: "Colorado Springs homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Battery backup is particularly important given winter storm power outages. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Colorado Springs Regional Building Department handles garage door replacement permits when structural headers or opening dimensions change. Local energy codes may require minimum insulation values on attached-garage doors.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Colorado Springs dealers. Broadmoor and Briargate have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Colorado Springs winter storms with ice and heavy snow load stress garage door springs and tracks. Annual maintenance inspection is recommended before November.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "Door insulation R-value is below R-12 on an attached garage in a cold climate",
    scenarios: "Budget single-car non-insulated steel door replacement in Colorado Springs runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "September-November and March-May",
    seasonalWorst: "December-February (emergency repairs from spring failures) and June-August (peak demand)",
    seasonalNote: "Colorado Springs garage door installers are busiest during spring when winter damage drives replacement demand. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },
...
/* =========================================================================
 * CITY_GARAGE_EXTRA3: additional per-metro paragraph fields.
 * Each block has >=2 metro-specific facts. No roof terms.
 * ========================================================================= */

const CITY_GARAGE_EXTRA3 = {
  "new-york-ny": {
    windCodeRatings: `NYC wind-code ratings for garage doors: ASCE 7-22 Exposure C at 110 mph applies to most outer borough residential (Staten Island, Queens, Bronx) with 120 mph for Rockaway Peninsula, Breezy Point, and coastal Staten Island. NYC Building Code §1609 governs wind-uplift calculation. DP (Design Pressure) rating of DP 30 is baseline for non-coastal NYC; DP 40 or DP 50 required for coastal-exposure zones. FEMA V-zone and A-zone post-Sandy mapping affects some Rockaway and South Shore Staten Island addresses requiring elevated garage slab.`,
    HOAColorStyleRules: `NYC HOA and co-op color restrictions: most NYC single-family is not HOA-governed but co-op boards in Forest Hills Gardens, Douglaston Hill, and Fieldston mandate specific colors and reject aluminum or modern glass-forward panels on street-facing elevations. Forest Hills Gardens Homes Association (1909, one of America's oldest) maintains strict Tudor Revival aesthetic. Landmarked LPC districts (Riverdale Fieldston, Brooklyn Heights, Cobble Hill) additionally require Certificate of No Effect review on any visible garage-door change.`,
    serviceCallPricing: `NYC garage-door service call pricing: standard diagnostic runs $120-$180 per visit outside Manhattan; Manhattan service calls typically start at $180-$260 due to parking and access premium. Spring replacement on torsion systems runs $350-$600 including labor and parts. Opener replacement runs $500-$950 installed. Cable replacement runs $180-$350. After-hours emergency service runs 1.5-2x standard rates. Co-op and condo service coordination with building management adds 30-60 minutes per call.`,
    weatherSealSpec: `NYC weather-seal specifications: EPDM rubber bottom seal is the durable NYC spec because DOT winter salt-spray destroys vinyl within 2 seasons. Top and side astragal seals require silicone or EPDM compound for freeze-thaw cycling. NYC Department of Environmental Protection salt-spray impact on garage-door hardware also drives stainless-steel hardware upgrades in salt-impacted zones. Seal replacement typically runs $150-$300 per door installed.`,
    springAndCable: `NYC spring and cable systems: extension-spring systems dominate older NYC single-family (Staten Island, Queens bungalow-era); torsion-spring systems are the modern Manhattan townhouse and upscale Brooklyn spec. Torsion springs with galvanized cables are the Manhattan and upper-Brooklyn standard due to duty-cycle demands in urban residential. Spring life runs 10,000-20,000 cycles on standard torsion; high-cycle 30,000 or 50,000 torsion adds $150-$350 to new-door installations on Brooklyn and Queens active-use properties.`,
    smartHomeIntegration: `NYC smart-home integration: LiftMaster MyQ and Genie Aladdin Connect dominate Manhattan townhouse and Brooklyn brownstone conversions. MyQ guest-code access integrates with Ring, August, and Amazon Key for dog-walker, cleaner, and delivery access without physical keys. NYC co-op and condo board approval often required before installing smart-home opener systems with Wi-Fi exposure. Integration with home assistants (Alexa, Google, Apple HomeKit) is typically opener-firmware and hub-configuration work; licensed installer adds $75-$150 for setup.`,
  },
  "los-angeles-ca": {
    windCodeRatings: `LA wind-code ratings for garage doors: ASCE 7-22 at 95 mph design wind speed for most residential with higher zones in Santa Monica Mountains and Verdugos. DP 22 baseline per Clopay recommendation; DP 30-40 recommended on canyon-adjacent Malibu and Pacific Palisades lots where Santa Ana winds exceed 70 mph. California Building Code Chapter 7A WUI compliance mandates ember-resistant garage-door detailing in very-high-severity fire-hazard zones (Mandeville Canyon, Bel Air, Sylmar).`,
    HOAColorStyleRules: `LA HOA color and style restrictions: Hancock Park, Brentwood, Pacific Palisades, and Laughlin Park HOAs maintain strict color palettes rejecting primary colors and high-gloss finishes. HPOZ Cultural Heritage Commission review applies to West Adams, Angelino Heights, and Miracle Mile; period-accurate Douglas fir or stained-wood carriage-house styles are common requirements. Glass-forward Mid-Century aluminum doors require HOA approval in traditional neighborhoods but are standard in Hollywood Hills and Silver Lake Modernist tracts.`,
    serviceCallPricing: `LA garage-door service call pricing: standard diagnostic runs $100-$160 per visit. Hillside access in Mulholland and Bel Air adds $40-$80 per call. Spring replacement on torsion systems runs $320-$580 including labor and parts. Opener replacement runs $480-$900 installed. Cable replacement runs $170-$320. After-hours emergency service runs 1.5-2x standard rates. LA traffic timing affects service-call scheduling; morning slots in Westside and Valley fill quickly.`,
    weatherSealSpec: `LA weather-seal specifications: EPDM rubber bottom seal withstands LA UV and temperature cycling better than vinyl. Top and side astragal seals use silicone or EPDM compound. Coastal Westside (Venice, Mar Vista, Santa Monica) salt-air exposure drives stainless-steel hardware upgrades and EPDM seal selection. WUI fire-zone properties require ember-resistant weather-seal detailing under Chapter 7A. Seal replacement typically runs $120-$260 per door.`,
    springAndCable: `LA spring and cable systems: torsion-spring systems dominate modern LA tract construction (1980s onward) and custom homes. Extension-spring systems appear on older Valley ranch and 1950s-1970s tract housing. Galvanized cables are standard; stainless-steel cables on Westside marine-exposure properties. Spring life runs 10,000-20,000 cycles on standard torsion. High-cycle 30,000-50,000 torsion systems for Hancock Park and Brentwood active-use properties add $150-$300 to new-door installations.`,
    smartHomeIntegration: `LA smart-home integration: LiftMaster MyQ dominates $600K+ LA homes since Angelenos treat garages as primary entry from alleys. MyQ guest-code integration for pool, landscape, housekeeper, and delivery access is standard. HomeKit integration via LiftMaster 8500W with HomeKit bridge is LA-preferred. Genie Aladdin Connect appears on value-tier installations. LA security-concern zip codes benefit from smart-home camera integration at garage entry; licensed installer adds $75-$150 for setup.`,
  },
  "chicago-il": {
    windCodeRatings: `Chicago wind-code ratings for garage doors: ASCE 7-22 at 105 mph design wind speed with Exposure C for most residential. DP 30 baseline; DP 40 recommended for southwest suburbs overlapping F2+ tornado corridor (Naperville, Orland Park, Tinley Park). Chicago Building Code 18-27 governs wind-uplift. UL 2218 Class 4 impact-rated doors earn 8-15% State Farm and USAA insurance discount in hail-exposed north-shore zones (Winnetka, Wilmette, Glencoe).`,
    HOAColorStyleRules: `Chicago HOA color and style restrictions: Winnetka, Wilmette, Glencoe, and Kenilworth HOAs maintain north-shore aesthetic standards with specific color palettes and styles. Chicago Lincoln Park Conservation Area guidelines force carriage-house styles on any garage visible from public way. Landmarked Old Town, Pullman, Prairie Avenue additionally require Commission on Chicago Landmarks review on garage-door changes. Most central Chicago single-family is not HOA-governed but Lincoln Park Conservation Area applies.`,
    serviceCallPricing: `Chicago garage-door service call pricing: standard diagnostic runs $100-$150 per visit. North-shore Winnetka and Wilmette service calls start at $140-$200. Spring replacement on torsion systems runs $340-$600 including labor and parts. Opener replacement runs $500-$950 installed. Cable replacement runs $170-$340. Winter service (sub-zero ambient) requires specific cold-weather protocols and adds 20-35% to labor. After-hours emergency service runs 1.5-2x standard rates.`,
    weatherSealSpec: `Chicago weather-seal specifications: EPDM rubber bottom seal with secondary compression layer is the Chicago upgrade due to severe freeze-thaw cycling. Vinyl seals fail within 3-5 years in Chicago climate. Top and side astragal seals use silicone or EPDM compound; acrylic-latex seals fail rapidly in Chicago freeze-thaw. DOT winter salt-spray accelerates hardware corrosion in alley-adjacent bungalow garages. Seal replacement typically runs $180-$340 per door.`,
    springAndCable: `Chicago spring and cable systems: torsion-spring systems dominate modern Chicago single-family and small multi-family. Extension-spring systems appear on older bungalow and two-flat housing. Galvanized cables are standard; stainless-steel cables on lakefront properties. Chicago freeze-thaw cycling stresses spring cycles; high-cycle 30,000 torsion systems are increasingly common spec ($150-$300 premium over standard). Lake-effect ice loading on flat Wicker Park garage roofs drives 240-lb torsion spring ratings.`,
    smartHomeIntegration: `Chicago smart-home integration: LiftMaster MyQ is standard in $500K+ north-shore homes. Genie Aladdin Connect appears on value-tier installations. Chicago active-use properties (school-age children, multi-vehicle households) benefit from MyQ integration with smart-home ecosystems. Cold-weather Wi-Fi reliability on openers with outdoor modules requires proper wintering protocols; opener firmware must handle sub-zero ambient. Licensed installer setup runs $75-$150 for MyQ or Aladdin Connect.`,
  },
  "houston-tx": {
    windCodeRatings: `Houston wind-code ratings for garage doors: Houston-Galveston Building Code Amendment requires DP 30+ on residential garage doors within Harris County wind zones. ASCE 7-22 at 130 mph design speed for most Harris County, higher near Galveston Bay. Clear Lake, Kemah, Seabrook, and Galveston County require WPI-8 (Windstorm Protection Installation) certification before TWIA will bind coverage. Hurricane Harvey (2017) and Beryl (2024) claim data pushed Texas Department of Insurance stricter WPI-8 enforcement on 14 coastal counties.`,
    HOAColorStyleRules: `Houston HOA color and style restrictions: Memorial Villages, Piney Point Village, Hunters Creek, and Bunker Hill HOAs forbid white or black street-facing doors, forcing warm neutrals and heritage greens on premium installs. River Oaks architectural review boards require pre-approval on any exterior color change. Heights HAHC review applies on contributing structures. Pure wood doors delaminate within 3-5 years in Houston's dew-point range, so even high-end bids specify wood-grain fiberglass or wood-overlay steel.`,
    serviceCallPricing: `Houston garage-door service call pricing: standard diagnostic runs $95-$145 per visit. Memorial and River Oaks service calls start at $130-$190. Spring replacement on torsion systems runs $300-$560 including labor and parts. Opener replacement runs $450-$850 installed. Cable replacement runs $150-$310. Hurricane season scheduling demands create 4-8 week backlogs after major events. After-hours emergency service runs 1.5-2x standard rates.`,
    weatherSealSpec: `Houston weather-seal specifications: EPDM rubber bottom seal is the durable Houston spec in 95%+ humidity. Top and side astragal seals require UV-resistant silicone or EPDM compound. Polystyrene-board-insulated doors without vapor barrier can trap condensation behind seals; polyurethane-injected doors with sealed steel skins block vapor better. Coastal Clear Lake and Galveston Bay salt-air exposure drives stainless-steel hardware. Seal replacement typically runs $130-$280 per door.`,
    springAndCable: `Houston spring and cable systems: torsion-spring systems dominate modern Houston tract construction (1980s onward) and custom homes. Extension-spring systems appear on older 1960s-1970s Houston tract housing. Galvanized cables are standard; stainless-steel cables on coastal Clear Lake and Galveston properties. Spring life runs 10,000-20,000 cycles standard. High-cycle 30,000 torsion systems common on Memorial and West University active-use properties. Hurricane wind-load ratings affect cable and spring specification on coastal installations.`,
    smartHomeIntegration: `Houston smart-home integration: LiftMaster 8500 jackshaft and MyQ integration is popular in two-story Houston homes because attic temperatures exceed 140F in August and bake ceiling-mounted openers. MyQ guest-code integration with Ring and Amazon Key is standard in Memorial and West University. CenterPoint Energy summer brownout frequency drives near-universal battery backup upgrades coordinated with smart-home opener installations. Licensed installer setup runs $75-$150 for MyQ or Aladdin Connect.`,
  },
  "phoenix-az": {
    windCodeRatings: `Phoenix wind-code ratings for garage doors: ASCE 7-22 at 105 mph design wind speed for most residential. DP 30+ voluntary upgrade in Anthem, Cave Creek, and Fountain Hills due to July-August monsoon microburst gusts of 80-100 mph. 2021 Chandler haboob destroyed 340 garage doors in one weekend, driving insurance-company pressure for DP 40 minimums on new installations. Maricopa County Building Code governs but enforces wind-uplift less strictly than hurricane-zone metros.`,
    HOAColorStyleRules: `Phoenix HOA color and style restrictions: DC Ranch, Troon North, Silverleaf, Desert Mountain, and Summerlin-style master-planned community HOAs maintain approved-color palettes of 12-18 earth tones and reject primary colors and high-gloss finishes on street-facing doors. Arcadia and Biltmore architectural review boards require pre-approval on any custom door order. Summerlin-style glass-forward moderns appear in Paradise Valley but require monsoon-rated laminated glazing because July microbursts can launch gravel at 80-100 mph.`,
    serviceCallPricing: `Phoenix garage-door service call pricing: standard diagnostic runs $90-$140 per visit. Scottsdale and Paradise Valley service calls start at $120-$180. Spring replacement on torsion systems runs $290-$540 including labor and parts. Opener replacement runs $430-$820 installed. Cable replacement runs $140-$290. Summer service scheduling requires early-morning visits (7 AM-10 AM) to avoid extreme ambient temperatures. After-hours emergency service runs 1.5-2x standard rates.`,
    weatherSealSpec: `Phoenix weather-seal specifications: EPDM rubber bottom seal is Phoenix-durable against extreme UV. Standard vinyl seals fail within 3-4 years in Phoenix UV. Top and side astragal seals require UV-stabilized silicone or EPDM compound. UV-stabilized finishes separate long-life doors from budget installs. Monsoon dust-storm debris accumulates on weather-seals; annual cleaning extends service. Seal replacement typically runs $120-$260 per door.`,
    springAndCable: `Phoenix spring and cable systems: torsion-spring systems dominate Phoenix master-planned community construction. Extension-spring systems are rare in modern Phoenix. Galvanized cables are standard; dry-desert climate extends cable life vs humid metros. Spring life runs 10,000-20,000 cycles on standard torsion. High-cycle 30,000-50,000 torsion systems on DC Ranch and Paradise Valley active-use properties add $150-$300 to installations.`,
    smartHomeIntegration: `Phoenix smart-home integration: LiftMaster MyQ and Genie Aladdin Connect dominate $600K+ Phoenix homes. MyQ guest-code integration is standard in master-planned communities where pool, landscape, and housekeeper access is routine. APS and SRP summer load-shedding frequency drives near-universal battery backup upgrades coordinated with smart-home opener installations. Smart openers with thermal-rated electronics ($50-$75 upcharge) pay for themselves in first August replacement cycle. Licensed installer setup runs $75-$150.`,
  },
  "dallas-tx": {
    windCodeRatings: `Dallas wind-code ratings for garage doors: Dallas 2018 IRC amendments require DP 30 minimum on new construction. UL 2218 Class 4 impact rating earns insurance premium discounts of 8-15% across Texas. ASCE 7-22 at 115 mph design wind speed for most residential. Tornado-corridor exposure from 2019 and 2023 outbreak events drives insurance-company mandates for DP 40+ on some zip codes. Class 4 impact-rated doors pay back the $400-$800 upgrade in 4-6 years of premium savings.`,
    HOAColorStyleRules: `Dallas HOA color and style restrictions: Highland Park Town, Preston Hollow, and University Park architectural review boards require stained wood or wood-look doors on homes valued above $2M and prohibit visible plastic trim. March 2023 Dallas hail event generated 58,000 garage-door insurance claims in DFW metro and drove UL 2218 Class 4 impact-rated steel to near-standard in $5K-$10K tier. Historic Districts (Munger Place, Winnetka Heights, Swiss Avenue) add Landmark Commission design review of 30-45 days.`,
    serviceCallPricing: `Dallas garage-door service call pricing: standard diagnostic runs $90-$145 per visit. Park Cities service calls start at $130-$200. Spring replacement on torsion systems runs $310-$570 including labor and parts. Opener replacement runs $460-$870 installed. Cable replacement runs $160-$310. Post-hail demand surges create 6-10 week service backlogs. After-hours emergency service runs 1.5-2x standard rates. Hail-damage service coordination with insurance adjuster is routine DFW protocol.`,
    weatherSealSpec: `Dallas weather-seal specifications: EPDM rubber bottom seal withstands DFW thermal cycling and hail impact. Top and side astragal seals use silicone or EPDM. DFW 2-3 annual hail events stress weather-seal integrity; damaged seals require post-hail replacement. Uri 2021 freeze-shock damage to standard vinyl seals drove upgrade to cold-rated EPDM. Seal replacement typically runs $140-$290 per door.`,
    springAndCable: `Dallas spring and cable systems: torsion-spring systems dominate modern DFW tract construction and custom homes. Extension-spring systems rare in post-2000 construction. Galvanized cables standard; stainless-steel cables on higher-end Park Cities installations. Spring life runs 10,000-20,000 cycles. High-cycle 30,000 torsion systems on active-use Lakewood and Preston Hollow properties. UL 2218 Class 4 impact-rated doors may have reinforced cable spec; verify at contract.`,
    smartHomeIntegration: `Dallas smart-home integration: LiftMaster Elite Series belt-drive with MyQ integration is standard in Park Cities since homeowners routinely grant housekeepers, pool techs, and Amazon drivers one-time codes. Oncor summer brownout frequency drives near-universal battery backup upgrades in University Park and Highland Park. MyQ integration with Ring, Nest, and Amazon Key is standard in $10K+ installations. Licensed installer setup runs $75-$150.`,
  },
  "atlanta-ga": {
    windCodeRatings: `Atlanta wind-code ratings for garage doors: ASCE 7-22 at 115 mph design wind speed for most residential with Exposure B/C. DP 30 baseline, DP 40 on west-of-I-285 tornado-corridor properties. 2011 and 2014 tornado outbreaks flagged Northwest Atlanta as recurring severe-weather corridor. Impact-rated glazing on garage-door windows is not required by Atlanta building code but strongly recommended on west and south elevations for homes within I-285 perimeter.`,
    HOAColorStyleRules: `Atlanta HOA color and style restrictions: Chastain Park, Tuxedo Park, Sandy Springs Riverside, and Buckhead HOAs require pre-approval for any exterior color change and prohibit modern full-view glass doors on street-facing elevations. AUDC historic district review applies to Inman Park, Virginia-Highland, Druid Hills, and Grant Park on contributing structures. Atlanta's pine-pollen season (March-April) coats new installs within days, driving fluoropolymer finishes over acrylic for easier spring washdowns.`,
    serviceCallPricing: `Atlanta garage-door service call pricing: standard diagnostic runs $95-$150 per visit. Buckhead and Morningside service calls start at $130-$190. Spring replacement on torsion systems runs $310-$560 including labor and parts. Opener replacement runs $470-$880 installed. Cable replacement runs $160-$320. After-hours emergency service runs 1.5-2x standard rates. Steep-hill access on Buckhead and Morningside properties may add $40-$80 per call.`,
    weatherSealSpec: `Atlanta weather-seal specifications: EPDM rubber bottom seal withstands Piedmont humidity and thermal cycling. Top and side astragal seals use silicone or EPDM. Atlanta's red-clay dust from active construction sites in Midtown and Cabbagetown pits raw aluminum within 2-3 years; coated steel with wood-grain overlay is the dominant material in $3K-$6K tier. Seal replacement typically runs $140-$290 per door.`,
    springAndCable: `Atlanta spring and cable systems: torsion-spring systems dominate modern Atlanta tract construction. Extension-spring systems rare. Galvanized cables standard; stainless-steel cables on higher-end installations. Belt-drive 3/4 HP is standard in Buckhead and Virginia-Highland because double-wide insulated doors weigh 180-220 lbs and need extra torque to avoid burning out openers. High-cycle torsion systems on active-use Buckhead properties add $150-$300.`,
    smartHomeIntegration: `Atlanta smart-home integration: LiftMaster Security+ 2.0 rolling-code openers are the 2026 baseline for Cobb and DeKalb County installs. MyQ integration with Ring and Amazon Key is standard in Buckhead and Morningside. Georgia Power summer storm frequency drives battery backup upgrades. MyQ HomeKit integration via bridge ($50 upcharge) popular in Atlanta's Apple-heavy demographics. Licensed installer setup runs $75-$150.`,
  },
  "denver-co": {
    windCodeRatings: `Denver wind-code ratings for garage doors: ASCE 7-22 at 105 mph design wind speed with chinook-wind gust zones in specific canyon-mouth areas (Boulder, Golden) reaching 80-100 mph. DP 30 baseline; DP 40+ recommended on canyon-adjacent foothill properties. Front Range hail corridor drives UL 2218 Class 4 impact-rated demand; Class 4 doors qualify for 8-15% insurance premium reductions on most Colorado policies written after 2022. Altitude-specific high-cycle spring ratings needed above 7,000 feet.`,
    HOAColorStyleRules: `Denver HOA color and style restrictions: Cherry Hills Village, Greenwood Village, and Evergreen HOAs maintain mountain-aesthetic standards with specific color palettes favoring earth tones. Denver Landmark Preservation Commission review applies to Capitol Hill, Country Club, and Baker historic districts. Highlands Ranch and Centennial master-planned HOAs require pre-approval on color and profile. Post-hail recovery projects must coordinate HOA approval before replacement.`,
    serviceCallPricing: `Denver garage-door service call pricing: standard diagnostic runs $100-$155 per visit. Cherry Creek and Country Club service calls start at $140-$210. Spring replacement on torsion systems runs $330-$590 including labor and parts. Opener replacement runs $490-$900 installed. Cable replacement runs $170-$330. Winter service requires specific cold-weather protocols and adds 20-30% to labor. Post-hail demand surges create 8-14 week service backlogs.`,
    weatherSealSpec: `Denver weather-seal specifications: EPDM rubber bottom seal is the durable Denver spec against severe freeze-thaw cycling. Top and side astragal seals use silicone or EPDM compound. High-altitude UV at 5,280 feet stresses seal service life; unprotected seals fail within 4-5 years vs 8-10 in milder climates. Front Range hail impact on seals drives post-storm replacement. Seal replacement typically runs $150-$300 per door.`,
    springAndCable: `Denver spring and cable systems: torsion-spring systems dominate modern Denver tract construction. Extension-spring systems appear on older 1950s-1970s Denver housing. Galvanized cables standard; stainless-steel cables on higher-end installations. Spring life runs 10,000-20,000 cycles. High-cycle 30,000 torsion systems on active-use Cherry Creek and Country Club properties. Altitude-specific spring ratings above 7,000 feet (Evergreen, Conifer) require specific engineering. Cable and spring replacement post-hail event is common.`,
    smartHomeIntegration: `Denver smart-home integration: LiftMaster MyQ dominates $500K+ Denver homes. MyQ integration with Ring and Amazon Key is standard in Cherry Hills Village and Greenwood Village. Xcel Energy winter-storm outage frequency drives battery backup upgrades. MyQ HomeKit integration via bridge popular in Denver's tech-heavy demographics. Licensed installer setup runs $75-$150.`,
  },
  "seattle-wa": {
    windCodeRatings: `Seattle wind-code ratings for garage doors: ASCE 7-22 at 85 mph design wind speed for most residential with higher zones on coastal-adjacent West Seattle and Alki. DP 22 baseline, DP 30+ recommended on waterfront-adjacent and windstorm-exposure properties. Pacific winter windstorms drive 50-70 mph sustained gusts and occasional 80-100 mph bomb-cyclone events. Cascadia earthquake seismic considerations affect garage-door anchor system detailing.`,
    HOAColorStyleRules: `Seattle HOA color and style restrictions: Laurelhurst, Broadmoor, and Madrona HOAs maintain specific color palettes favoring Pacific Northwest heritage colors. Seattle Landmarks Preservation Board review applies to Pioneer Square, Harvard-Belmont, and Ballard Avenue on contributing structures. Craftsman and Tudor-style homes in Queen Anne and Capitol Hill require carriage-house or period-appropriate garage-door aesthetics. Modern glass-forward doors common in Sand Point and View Ridge modern builds.`,
    serviceCallPricing: `Seattle garage-door service call pricing: standard diagnostic runs $100-$155 per visit. Queen Anne, Madrona, and Mercer Island service calls start at $140-$210. Spring replacement on torsion systems runs $340-$600 including labor and parts. Opener replacement runs $500-$920 installed. Cable replacement runs $170-$330. Rainy-season service requires specific protection protocols. After-hours emergency service runs 1.5-2x standard rates.`,
    weatherSealSpec: `Seattle weather-seal specifications: EPDM rubber bottom seal is Seattle-durable against marine moisture. Top and side astragal seals use silicone or EPDM. Sustained atmospheric-river rainfall stresses seal integrity; annual inspection prudent. Coastal-adjacent West Seattle and Magnolia salt-air exposure drives stainless-steel hardware upgrades. Biological growth on rubber seals requires periodic cleaning. Seal replacement typically runs $150-$300 per door.`,
    springAndCable: `Seattle spring and cable systems: torsion-spring systems dominate modern Seattle single-family. Extension-spring systems appear on older Craftsman-era housing. Galvanized cables standard; stainless-steel cables on coastal West Seattle and Alki properties. Spring life runs 10,000-20,000 cycles standard. High-cycle 30,000 torsion systems on active-use Queen Anne and Laurelhurst properties. Cable and spring service is more difficult in rainy season; scheduling May-September preferred.`,
    smartHomeIntegration: `Seattle smart-home integration: LiftMaster MyQ dominates $600K+ Seattle homes. MyQ integration with Ring, Amazon Key, and Apple HomeKit is standard in Laurelhurst and Madrona. Seattle City Light winter-storm outage frequency drives battery backup upgrades. Smart openers with moisture-rated electronics perform well in Seattle marine climate. Licensed installer setup runs $75-$150.`,
  },
  "austin-tx": {
    windCodeRatings: `Austin wind-code ratings for garage doors: ASCE 7-22 at 105 mph design wind speed for most residential with Exposure B/C. DP 30 baseline, DP 40+ recommended on west Travis County hillside properties exposed to Hill Country wind events. 2-4 annual damaging hail events drive UL 2218 Class 4 impact-rated demand. Uri 2021 freeze-shock damage on standard garage doors drove spec updates for thermally-stable materials.`,
    HOAColorStyleRules: `Austin HOA color and style restrictions: Westlake, Rollingwood, Barton Creek, and Circle C HOAs maintain specific color palettes. Austin Historic Landmark Commission review applies to Hyde Park, Travis Heights, Clarksville, and Old West Austin on contributing structures. Limestone-faced West Austin homes often require limestone-matching door colors. Mueller and Circle C new-construction tracts have specific builder-established aesthetics on initial installations.`,
    serviceCallPricing: `Austin garage-door service call pricing: standard diagnostic runs $95-$150 per visit. West Austin (Westlake, Rollingwood) service calls start at $130-$195. Spring replacement on torsion systems runs $310-$560 including labor and parts. Opener replacement runs $470-$880 installed. Cable replacement runs $160-$320. Post-Uri 2021 demand created 4-8 week service backlogs. After-hours emergency service runs 1.5-2x standard rates.`,
    weatherSealSpec: `Austin weather-seal specifications: EPDM rubber bottom seal withstands Hill Country thermal cycling. Top and side astragal seals use silicone or EPDM. Post-Uri 2021 freeze-crack damage on standard vinyl seals drove upgrade to cold-rated EPDM. Austin UV stresses unprotected seals; UV-stabilized EPDM or silicone extends service. Seal replacement typically runs $130-$270 per door.`,
    springAndCable: `Austin spring and cable systems: torsion-spring systems dominate modern Austin tract construction. Extension-spring systems rare in post-2000 construction. Galvanized cables standard; stainless-steel cables on higher-end Westlake installations. Spring life runs 10,000-20,000 cycles. High-cycle 30,000 torsion systems on active-use West Austin and Circle C properties. Post-Uri 2021 cable and spring stress drove inspection protocols.`,
    smartHomeIntegration: `Austin smart-home integration: LiftMaster MyQ dominates $500K+ Austin homes. MyQ integration with Ring, Nest, Amazon Key, and Apple HomeKit is standard in West Austin and Circle C. Austin Energy TOU peak hours drive smart-scheduling integration for cooling-load reduction. Austin's tech-heavy demographics drive higher smart-home adoption than most Texas metros. Licensed installer setup runs $75-$150.`,
  },
  "san-francisco-ca": {
    windCodeRatings: `SF wind-code ratings for garage doors: ASCE 7-22 at 85 mph design wind speed for most residential with Exposure B/C. DP 22 baseline, DP 30+ recommended on coastal-zone and exposed-hillside properties. Pacific winter windstorms drive 50-70 mph sustained gusts and occasional atmospheric-river windstorm events. Cascadia earthquake seismic considerations drive anchor-system detailing; soft-story retrofits under SF ordinance §34B affect some ground-floor garage openings.`,
    HOAColorStyleRules: `SF HOA and neighborhood restrictions: most SF single-family is not HOA-governed but SF Planning Code historic review applies broadly in landmark districts (Alamo Square, Jackson Square, Liberty-Hill, Dogpatch, Chinatown, Webster Street). Victorian painted ladies typically require period-accurate garage-door styles; most SF Victorians and Edwardians have limited street-facing garage exposure due to tuck-under geometry. Coastal Commission permitting adds regulatory layer for coastal-zone garage-door work.`,
    serviceCallPricing: `SF garage-door service call pricing: standard diagnostic runs $120-$185 per visit (highest of any major US metro due to dense-urban access and labor costs). Pacific Heights and Presidio Heights service calls start at $160-$240. Spring replacement on torsion systems runs $370-$660 including labor and parts. Opener replacement runs $540-$990 installed. Cable replacement runs $190-$360. SF parking-permit staging adds $75-$150 per job.`,
    weatherSealSpec: `SF weather-seal specifications: EPDM rubber bottom seal is SF-durable against marine moisture. Top and side astragal seals use silicone or EPDM compound. Sustained fog-belt moisture exposure stresses seals; annual inspection prudent. Coastal-adjacent properties within 1 mile of Pacific or Bay require stainless-steel hardware and marine-coated components. Biological growth on rubber seals requires periodic cleaning. Seal replacement typically runs $170-$340 per door.`,
    springAndCable: `SF spring and cable systems: torsion-spring systems dominate modern SF single-family. Extension-spring systems appear on older 1920s-1950s SF tuck-under garages. Galvanized cables standard; stainless-steel cables on coastal Sea Cliff, Marina, Presidio Heights properties. Spring life runs 10,000-20,000 cycles standard. Victorian and Edwardian tuck-under garages often have custom spring configurations requiring specialty installer expertise. High-cycle systems on Pacific Heights active-use properties.`,
    smartHomeIntegration: `SF smart-home integration: LiftMaster MyQ dominates $1M+ SF homes. MyQ integration with Ring, Nest, Amazon Key, and Apple HomeKit is standard in Pacific Heights and Sea Cliff. SF's tech-heavy demographics drive highest smart-home adoption in US metros. PG&E public-safety power shutoff frequency drives battery backup upgrades. Licensed installer setup runs $75-$150. SF dust-control ordinance §3428 affects smart-device installation on pre-1978 homes.`,
  },
  "las-vegas-nv": {
    windCodeRatings: `Vegas wind-code ratings for garage doors: ASCE 7-22 at 115 mph design wind speed for most residential due to high-plateau exposure. DP 30 baseline, DP 40+ recommended in Anthem, Henderson hillside, and MacDonald Ranch properties exposed to monsoon-season microbursts. 2021 Chandler-style haboob events occasionally affect Vegas metro. July-August microburst gusts can exceed 80 mph. Class 4 impact-rated doors offer modest insurance benefit.`,
    HOAColorStyleRules: `Vegas HOA color and style restrictions: Summerlin, Anthem, MacDonald Ranch, Seven Hills, and Red Rock Country Club HOAs maintain strict approved-color palettes favoring desert-earth tones and rejecting primary colors or high-gloss finishes. Summerlin has 12-18 ARC-approved colors. Huntridge and John S. Park historic districts require HPC review on contributing structures. Most Vegas single-family is HOA-governed; HOA pre-approval is more time-consuming than Clark County permit.`,
    serviceCallPricing: `Vegas garage-door service call pricing: standard diagnostic runs $90-$145 per visit. Summerlin and Henderson service calls start at $120-$180. Spring replacement on torsion systems runs $300-$550 including labor and parts. Opener replacement runs $450-$850 installed. Cable replacement runs $150-$300. Summer service requires early-morning visits (7 AM-11 AM) to avoid surface temperatures exceeding 150F. After-hours emergency service runs 1.5-2x standard rates.`,
    weatherSealSpec: `Vegas weather-seal specifications: EPDM rubber bottom seal withstands extreme UV and heat cycling. Standard vinyl seals fail within 3-4 years in Vegas UV. Top and side astragal seals require UV-stabilized silicone or EPDM compound. Monsoon dust-storm debris accumulates on seals; annual cleaning extends service. Seal replacement typically runs $120-$260 per door.`,
    springAndCable: `Vegas spring and cable systems: torsion-spring systems dominate modern Vegas master-planned community construction. Extension-spring systems rare. Galvanized cables standard; dry-desert climate extends cable life vs humid metros. Spring life runs 10,000-20,000 cycles on standard torsion. High-cycle 30,000-50,000 torsion systems on Summerlin and Anthem active-use properties. Hot-attic-temperature durability affects spring and cable life on ceiling-rail installations.`,
    smartHomeIntegration: `Vegas smart-home integration: LiftMaster MyQ dominates $600K+ Vegas homes. MyQ integration with Ring and Amazon Key is standard in Summerlin and Anthem. NV Energy summer load-shedding frequency drives near-universal battery backup upgrades. Smart openers with thermal-rated electronics ($50-$75 upcharge) pay for themselves in first August replacement cycle. Licensed installer setup runs $75-$150.`,
  },
  "philadelphia-pa": {
    windCodeRatings: `Philadelphia wind-code ratings for garage doors: ASCE 7-22 at 100 mph design wind speed with Exposure B for most residential. DP 25-30 baseline. Delaware River flood-zone properties in Old City, Port Richmond, Pennsport may have specific elevation and anchor requirements. Hurricane Sandy 2012 damage patterns influenced subsequent Pennsylvania code amendments. Hurricane-remnant storm exposure (Ida 2021) produces occasional wind damage. Philadelphia rowhouse tuck-under garages have distinct wind-load characteristics.`,
    HOAColorStyleRules: `Philadelphia HOA and neighborhood restrictions: most Philly rowhouse and single-family is not HOA-governed but Philadelphia Historical Commission review applies broadly in landmark districts (Society Hill, Old City, Rittenhouse, Chestnut Hill, Germantown). Rowhouse front-facing garage doors in Fishtown, Northern Liberties, and South Philly are subject to neighborhood aesthetic expectations. Chestnut Hill stone-faced homes require stone-matching or heritage-green doors. Landmark review adds 6-12 weeks.`,
    serviceCallPricing: `Philadelphia garage-door service call pricing: standard diagnostic runs $100-$155 per visit. Chestnut Hill and Society Hill service calls start at $140-$210. Spring replacement on torsion systems runs $330-$590 including labor and parts. Opener replacement runs $490-$900 installed. Cable replacement runs $170-$330. Rowhouse service coordination with adjacent properties may require scheduling flexibility. After-hours emergency service runs 1.5-2x standard rates. Center City parking permit staging may require additional $50-$100 per call on rowhouse service where street parking is limited.`,
    weatherSealSpec: `Philadelphia weather-seal specifications: EPDM rubber bottom seal withstands Philly freeze-thaw cycling. Top and side astragal seals use silicone or EPDM. Philadelphia Department of Streets winter salt-spray corrodes hardware within 5-7 years on uncoated galvanized steel. Stainless-steel hardware upgrades extend service in salt-impacted rowhouse neighborhoods. Biological growth on north-facing rubber seals requires periodic cleaning. Seal replacement typically runs $150-$300 per door.`,
    springAndCable: `Philadelphia spring and cable systems: torsion-spring systems dominate modern Philly single-family and suburban housing. Extension-spring systems appear on older rowhouse tuck-under garages. Galvanized cables standard; stainless-steel cables on higher-end Chestnut Hill and Society Hill installations. Rowhouse tuck-under garages often have custom spring configurations requiring specialty expertise. Spring life runs 10,000-20,000 cycles.`,
    smartHomeIntegration: `Philadelphia smart-home integration: LiftMaster MyQ dominates $500K+ Philly homes. MyQ integration with Ring, Amazon Key, and Apple HomeKit is standard in Chestnut Hill and Society Hill. PECO winter-storm outage frequency drives battery backup upgrades. Rowhouse shared-wall considerations affect Wi-Fi signal strength on opener systems. Licensed installer setup runs $75-$150.`,
  },
  "miami-fl": {
    windCodeRatings: `Miami wind-code ratings for garage doors: Miami-Dade HVHZ requires Notice of Acceptance (NOA) documentation on every residential garage-door installation. ASCE 7-22 at 175 mph design wind speed for most residential, with higher zones on Miami Beach and Key Biscayne. DP 50+ mandatory on coastal-adjacent installations; Miami-Dade HVHZ DP rating typically DP 60-80 on waterfront properties. Hurricane Andrew 1992 and Irma 2017 drove code tightening; NOA expires every 5-7 years and manufacturer must re-test.`,
    HOAColorStyleRules: `Miami HOA and historic-district restrictions: Coral Gables (among strictest in US) requires Merrick-era Mediterranean Revival matching on contributing structures. Miami Beach Art Deco District requires specific 1920s-1940s aesthetic. MiMo Biscayne Boulevard requires Miami Modernism 1950s-1960s matching. Pinecrest, Coconut Grove, and Key Biscayne HOAs maintain specific color palettes. Landmark review adds 6-14 weeks on contributing structures.`,
    serviceCallPricing: `Miami garage-door service call pricing: standard diagnostic runs $100-$155 per visit. Coral Gables and Miami Beach service calls start at $140-$210. Spring replacement on torsion systems runs $340-$600 including labor and parts. Opener replacement runs $510-$940 installed. Cable replacement runs $180-$340. Hurricane season scheduling demands create 6-12 week backlogs after major events. After-hours emergency service runs 1.5-2x standard rates.`,
    weatherSealSpec: `Miami weather-seal specifications: EPDM rubber bottom seal withstands tropical humidity and salt exposure. Top and side astragal seals require salt-air-resistant silicone or EPDM. Coastal-adjacent Miami Beach, Key Biscayne, Sunny Isles, Bal Harbour salt-air exposure drives stainless-steel 316 hardware upgrades. Hurricane-rated weather-seal systems with enhanced compression are required on Miami-Dade HVHZ-compliant installations. Seal replacement typically runs $160-$320 per door.`,
    springAndCable: `Miami spring and cable systems: torsion-spring systems dominate modern Miami CBS residential. Extension-spring systems rare in modern construction. Stainless-steel cables standard on coastal-adjacent properties; galvanized cables corrode within 5-7 years on coastal installations. Hurricane-rated spring and cable systems on Miami-Dade HVHZ-compliant installations. Spring life runs 10,000-20,000 cycles. High-cycle systems on Coconut Grove and Coral Gables active-use properties.`,
    smartHomeIntegration: `Miami smart-home integration: LiftMaster MyQ and Genie Aladdin Connect dominate $600K+ Miami homes. MyQ integration with Ring and Amazon Key is standard in Coral Gables and Coconut Grove. Hurricane-season outage frequency drives battery backup upgrades. Smart openers with salt-air-rated electronics perform better in coastal-adjacent installations. Licensed installer setup runs $75-$150.`,
  },
  "boston-ma": {
    windCodeRatings: `Boston wind-code ratings for garage doors: ASCE 7-22 at 110 mph design wind speed with Exposure B for most residential and Exposure C on coastal-adjacent. DP 30 baseline, DP 40+ recommended on coastal-adjacent Winthrop, Nahant, Hull properties. Nor'easter winter storms drive sustained 50-70 mph gusts; 2015 record-snowfall winter stressed garage-door structural integrity. Massachusetts Stretch Code affects residential envelope performance including garage-to-living-space separation.`,
    HOAColorStyleRules: `Boston HOA and landmark-district restrictions: most Boston triple-decker and single-family is not HOA-governed but Boston Landmarks Commission review applies broadly in Back Bay, Beacon Hill, Fort Point, South End, Bay Village. Colonial-era homes in Cambridge and Brookline often have limited street-facing garage exposure due to compact lot layouts. Newton and Wellesley HOAs maintain specific aesthetic standards. Landmark review adds 6-10 weeks on contributing structures.`,
    serviceCallPricing: `Boston garage-door service call pricing: standard diagnostic runs $110-$170 per visit. Back Bay and Beacon Hill service calls start at $160-$230 (Manhattan-adjacent pricing). Spring replacement on torsion systems runs $350-$630 including labor and parts. Opener replacement runs $520-$960 installed. Cable replacement runs $180-$350. Winter service requires specific cold-weather protocols; heated tenting may be required on some installations. After-hours emergency service runs 1.5-2x standard rates.`,
    weatherSealSpec: `Boston weather-seal specifications: EPDM rubber bottom seal is the durable Boston spec against severe freeze-thaw cycling and nor'easter moisture. Top and side astragal seals require silicone or EPDM compound. Standard vinyl seals fail within 3-4 years in Boston climate. Coastal-adjacent salt-air exposure drives stainless-steel hardware. Ice-dam water intrusion at garage-to-living-space transitions drives specific sealing detail. Seal replacement typically runs $170-$340 per door.`,
    springAndCable: `Boston spring and cable systems: torsion-spring systems dominate modern Boston single-family. Extension-spring systems appear on older triple-decker and colonial-era housing. Galvanized cables standard; stainless-steel cables on coastal-adjacent properties. Boston freeze-thaw cycling stresses spring cycles; high-cycle 30,000 torsion systems are common upgrade ($150-$300 premium). Cable and spring service is more difficult in winter; scheduling April-October preferred.`,
    smartHomeIntegration: `Boston smart-home integration: LiftMaster MyQ dominates $700K+ Boston homes. MyQ integration with Ring, Amazon Key, and Apple HomeKit is standard in Back Bay, Beacon Hill, and Cambridge. Eversource and National Grid winter-storm outage frequency drives battery backup upgrades. Smart openers with cold-rated electronics perform better in sustained sub-freezing ambient. Licensed installer setup runs $75-$150.`,
  },
  "san-diego-ca": {
    windCodeRatings: `San Diego wind-code ratings for garage doors: ASCE 7-22 at 85 mph design wind speed for most residential with higher zones in canyon and mountain-adjacent East County. DP 22 baseline, DP 30+ recommended on Santa Ana wind-exposure properties. California Building Code Chapter 7A WUI compliance mandates ember-resistant detailing in very-high-severity fire hazard zones (Rancho Bernardo, Rancho Peñasquitos, Scripps Ranch, East County). California Coastal Commission jurisdiction adds regulatory layer.`,
    HOAColorStyleRules: `San Diego HOA color and style restrictions: Rancho Santa Fe, La Jolla, Del Mar, and Coronado HOAs maintain specific color palettes favoring coastal-traditional aesthetics. San Diego Historic Resources Board and Mills Act review applies to Mission Hills, Burlingame, South Park, La Jolla on qualifying properties. WUI fire-zone Chapter 7A compliance affects material selection on garage doors. Carmel Valley, Scripps Ranch, and Poway HOAs require pre-approval.`,
    serviceCallPricing: `San Diego garage-door service call pricing: standard diagnostic runs $100-$155 per visit. La Jolla and Rancho Santa Fe service calls start at $140-$210. Spring replacement on torsion systems runs $330-$590 including labor and parts. Opener replacement runs $490-$900 installed. Cable replacement runs $170-$330. Canyon and hillside access adds $40-$80 per call. After-hours emergency service runs 1.5-2x standard rates.`,
    weatherSealSpec: `San Diego weather-seal specifications: EPDM rubber bottom seal withstands coastal marine exposure. Top and side astragal seals use silicone or EPDM. Coastal-adjacent properties within 1 mile of Pacific require stainless-steel 316 hardware and marine-coated components; galvanized steel pits within 2-4 years. WUI fire-zone properties require ember-resistant weather-seal detailing. Seal replacement typically runs $150-$300 per door.`,
    springAndCable: `San Diego spring and cable systems: torsion-spring systems dominate modern SD tract construction. Extension-spring systems rare in post-2000 construction. Galvanized cables standard; stainless-steel cables on coastal-adjacent La Jolla, Del Mar, Coronado properties. Spring life runs 10,000-20,000 cycles. High-cycle 30,000 torsion systems on active-use Rancho Santa Fe and La Jolla properties. Canyon and hillside-lot installations may have custom spring configurations.`,
    smartHomeIntegration: `San Diego smart-home integration: LiftMaster MyQ dominates $700K+ SD homes. MyQ integration with Ring, Amazon Key, and Apple HomeKit is standard in La Jolla, Rancho Santa Fe, and Del Mar. SDG&E public-safety power shutoff frequency drives battery backup upgrades. SD's tech-heavy demographics drive higher smart-home adoption. Licensed installer setup runs $75-$150.`,
  },
  "tampa-fl": {
    windCodeRatings: `Tampa wind-code ratings for garage doors: Florida Product Approval (FPA) mandatory in wind-borne debris region (within 1 mile of coast in Hillsborough and Pinellas counties). ASCE 7-22 at 140 mph design wind speed for most residential, higher in Pinellas coastal-adjacent. DP 40+ mandatory on coastal-adjacent installations. Hurricane Irma 2017 and Ian 2022 drove code tightening. FPA documentation must appear on permit and final inspection card.`,
    HOAColorStyleRules: `Tampa HOA and historic-district restrictions: Hyde Park, South Tampa, and Davis Islands HOAs maintain specific color palettes favoring Florida-vernacular aesthetics. Tampa Historic Preservation Commission review applies to Hyde Park, Seminole Heights, Tampa Heights, Ybor City. Westchase, Carrollwood, and New Tampa master-planned communities require pre-approval. Landmark review adds 6-10 weeks on contributing structures.`,
    serviceCallPricing: `Tampa garage-door service call pricing: standard diagnostic runs $95-$150 per visit. South Tampa and Davis Islands service calls start at $130-$195. Spring replacement on torsion systems runs $310-$570 including labor and parts. Opener replacement runs $470-$880 installed. Cable replacement runs $160-$320. Hurricane season scheduling demands create 4-8 week backlogs after major events. After-hours emergency service runs 1.5-2x standard rates. Coastal-adjacent Clearwater Beach, St. Pete Beach service calls may require specialty marine-coated hardware adding 20-30% to parts cost. Post-hurricane emergency scheduling prioritizes life-safety installations ahead of non-critical service.`,
    weatherSealSpec: `Tampa weather-seal specifications: EPDM rubber bottom seal withstands Gulf Coast humidity and salt exposure. Top and side astragal seals require salt-air-resistant silicone or EPDM. Coastal-adjacent South Tampa, Davis Islands, Clearwater Beach, St. Pete Beach salt-air exposure drives stainless-steel 316 hardware upgrades. Hurricane-rated weather-seal systems required on FPA-compliant installations. Seal replacement typically runs $140-$290 per door.`,
    springAndCable: `Tampa spring and cable systems: torsion-spring systems dominate modern Tampa CBS residential. Extension-spring systems rare. Stainless-steel cables standard on coastal-adjacent properties. Hurricane-rated spring and cable systems on FPA-compliant installations. Spring life runs 10,000-20,000 cycles. High-cycle 30,000 torsion systems on Hyde Park and Davis Islands active-use properties.`,
    smartHomeIntegration: `Tampa smart-home integration: LiftMaster MyQ and Genie Aladdin Connect dominate $500K+ Tampa homes. MyQ integration with Ring and Amazon Key is standard in Hyde Park and South Tampa. Hurricane-season outage frequency drives battery backup upgrades. Smart openers with salt-air-rated electronics perform better in coastal-adjacent installations. Licensed installer setup runs $75-$150.`,
  },
  "detroit-mi": {
    windCodeRatings: `Detroit wind-code ratings for garage doors: ASCE 7-22 at 105 mph design wind speed with Exposure C for most residential. DP 30 baseline. Great Lakes lake-effect winter winds drive sustained 40-60 mph gusts. 2023 derecho produced widespread wind damage across Oakland and Macomb counties; post-derecho amendments may tighten wind-uplift specification. Winter snow-load considerations affect garage-door structural integrity on flat-roof and low-pitch garages.`,
    HOAColorStyleRules: `Detroit HOA and historic-district restrictions: Grosse Pointe, Birmingham, Bloomfield Hills, and Rochester HOAs maintain specific color palettes. Detroit Historic Designation Advisory Board review applies to Boston-Edison, Indian Village, Woodbridge, Palmer Park, Corktown. Rosedale Park and Sherwood Forest maintain aesthetic standards. Landmark review adds 4-8 weeks on contributing structures. Most Detroit city single-family is not HOA-governed.`,
    serviceCallPricing: `Detroit garage-door service call pricing: standard diagnostic runs $95-$150 per visit. Birmingham and Bloomfield Hills service calls start at $130-$195. Spring replacement on torsion systems runs $310-$570 including labor and parts. Opener replacement runs $470-$870 installed. Cable replacement runs $160-$320. Winter service requires specific cold-weather protocols and adds 20-30% to labor. After-hours emergency service runs 1.5-2x standard rates.`,
    weatherSealSpec: `Detroit weather-seal specifications: EPDM rubber bottom seal is the durable Detroit spec against severe freeze-thaw cycling. Standard vinyl seals fail within 3-4 years in Detroit climate. Top and side astragal seals require silicone or EPDM compound. Michigan DOT winter salt-spray corrodes hardware within 5-7 years on uncoated galvanized steel. Stainless-steel hardware upgrades extend service. Seal replacement typically runs $140-$290 per door.`,
    springAndCable: `Detroit spring and cable systems: torsion-spring systems dominate modern Detroit single-family. Extension-spring systems appear on older 1910s-1940s brick bungalow housing. Galvanized cables standard; stainless-steel cables on Grosse Pointe lakefront properties. Spring life runs 10,000-20,000 cycles. High-cycle 30,000 torsion systems on Birmingham and Bloomfield Hills active-use properties. Winter spring and cable service requires specific protocols.`,
    smartHomeIntegration: `Detroit smart-home integration: LiftMaster MyQ dominates $400K+ Detroit-metro homes. MyQ integration with Ring, Amazon Key, and Apple HomeKit is standard in Birmingham and Bloomfield Hills. DTE Energy winter-storm outage frequency drives battery backup upgrades. Smart openers with cold-rated electronics perform better in sustained sub-freezing ambient. Licensed installer setup runs $75-$150.`,
  },
  "minneapolis-mn": {
    windCodeRatings: `Minneapolis wind-code ratings for garage doors: ASCE 7-22 at 105 mph design wind speed with Exposure C for most residential. DP 30 baseline, DP 40 recommended on exposed lake-front and hail-corridor properties. Polar vortex and severe winter storms drive structural considerations. UL 2218 Class 4 impact-rated doors earn insurance premium discounts after 2-4 annual damaging hail events. Snow-load on flat-roof garages drives specific structural engineering.`,
    HOAColorStyleRules: `Minneapolis HOA and landmark-district restrictions: Edina, Wayzata, Lake Minnetonka, and Woodbury HOAs maintain specific color palettes favoring Twin Cities heritage aesthetics. Minneapolis Heritage Preservation Commission review applies to Milwaukee Avenue, Fourth Avenue, and Nicollet Island on contributing structures. Landmark review adds 4-8 weeks. St. Paul Summit Hill Heritage Preservation Commission oversees separate district. Most Twin Cities single-family is not HOA-governed but suburban master-planned communities require ARC approval.`,
    serviceCallPricing: `Minneapolis garage-door service call pricing: standard diagnostic runs $100-$155 per visit. Edina, Wayzata, and Kenwood service calls start at $140-$210. Spring replacement on torsion systems runs $330-$590 including labor and parts. Opener replacement runs $490-$900 installed. Cable replacement runs $170-$330. Winter service requires heated-tenting protocols during sub-zero ambient ($300-$500 per day premium). After-hours emergency service runs 1.5-2x standard rates.`,
    weatherSealSpec: `Minneapolis weather-seal specifications: EPDM rubber bottom seal is the most durable Minneapolis spec against the most severe freeze-thaw cycling in any US metro. Standard vinyl seals fail within 2-3 years in Minneapolis climate. Top and side astragal seals require silicone or EPDM compound rated for -20F ambient. Minnesota DOT winter salt-spray corrodes hardware. Ice-dam water intrusion at garage-to-living-space transitions drives specific sealing detail. Seal replacement typically runs $160-$330 per door.`,
    springAndCable: `Minneapolis spring and cable systems: torsion-spring systems dominate modern Twin Cities single-family. Extension-spring systems appear on older 1920s-1950s bungalow and four-square housing. Galvanized cables standard; stainless-steel cables on higher-end Edina and Wayzata installations. Minneapolis freeze-thaw cycling stresses spring cycles; high-cycle 30,000 torsion systems are common upgrade ($150-$300 premium). Cold-rated spring compounds required for -20F operating conditions.`,
    smartHomeIntegration: `Minneapolis smart-home integration: LiftMaster MyQ dominates $600K+ Twin Cities homes. MyQ integration with Ring, Amazon Key, and Apple HomeKit is standard in Edina, Wayzata, and Kenwood. Xcel Energy Minnesota and CenterPoint Energy winter-storm outage frequency drives near-universal battery backup upgrades. Smart openers with cold-rated electronics ($50-$100 upcharge) perform better in sustained -20F ambient. Licensed installer setup runs $75-$150.`,
  },
  "charlotte-nc": {
    windCodeRatings: `Charlotte wind-code ratings for garage doors: ASCE 7-22 at 110 mph design wind speed for most residential with Exposure B/C. DP 30 baseline, DP 40 recommended on Charlotte Regional Tornado Alley corridor properties. North Carolina Residential Code amendments post-Florence 2018 and post-2020 severe-weather outbreak require enhanced wind-uplift specifications. Class 4 impact-rated doors qualify for 5-10% insurance premium reductions on Charlotte policies written after 2022.`,
    HOAColorStyleRules: `Charlotte HOA color and style restrictions: SouthPark, Ballantyne, Myers Park, and Eastover HOAs maintain specific color palettes. Charlotte-Mecklenburg Historic District Commission review applies to Dilworth, Wesley Heights, Fourth Ward, Plaza Midwood on contributing structures. Landmark review adds 4-8 weeks. Matthews, Huntersville, and Lake Norman HOAs require pre-approval on garage-door replacement. Piedmont pollen-season (March-April) coats new installs requiring specific finish selection.`,
    serviceCallPricing: `Charlotte garage-door service call pricing: standard diagnostic runs $90-$145 per visit. Myers Park and Eastover service calls start at $120-$185. Spring replacement on torsion systems runs $300-$560 including labor and parts. Opener replacement runs $460-$860 installed. Cable replacement runs $150-$310. Post-hail demand surges create 4-8 week service backlogs. After-hours emergency service runs 1.5-2x standard rates.`,
    weatherSealSpec: `Charlotte weather-seal specifications: EPDM rubber bottom seal withstands Piedmont humidity and thermal cycling. Top and side astragal seals use silicone or EPDM. Pollen-season coating requires seal cleaning before fall-winter service. Biological growth on north-facing seals requires periodic cleaning. Seal replacement typically runs $130-$270 per door.`,
    springAndCable: `Charlotte spring and cable systems: torsion-spring systems dominate modern Charlotte tract construction. Extension-spring systems rare in post-2000 construction. Galvanized cables standard; stainless-steel cables on higher-end Myers Park and Eastover installations. Spring life runs 10,000-20,000 cycles. High-cycle 30,000 torsion systems on active-use SouthPark and Ballantyne properties. Post-hail cable and spring inspection is Charlotte-specific essential.`,
    smartHomeIntegration: `Charlotte smart-home integration: LiftMaster MyQ dominates $500K+ Charlotte-metro homes. MyQ integration with Ring, Amazon Key, and Apple HomeKit is standard in SouthPark, Ballantyne, and Myers Park. Duke Energy storm-season outage frequency drives battery backup upgrades. Charlotte's banking-tech demographics drive higher smart-home adoption than most Southeast metros. Licensed installer setup runs $75-$150.`,
  },
};

for (const slug in CITY_GARAGE_EXTRA3) {
  Object.assign(CITY_GARAGE_DATA[slug], CITY_GARAGE_EXTRA3[slug]);
}

const CITY_GARAGE_EXTRA4 = {
  "new-york-ny": {
    dealerLandscape: `NYC local dealer landscape: Raymond-Dieckmann (Glendale Queens), Ridgewood Overhead Door, and Home Depot Throggs Neck split most residential installs. Factory-direct Clopay and Amarr dealers operate out of Westchester and Nassau County, which means Manhattan and Brooklyn jobs pay a 15-20 percent metro premium for truck-staging permits. Wayne Dalton ships to NYC through the Cherry Hill NJ distribution hub. LiftMaster regional rep coverage spans NYC, Long Island, and Westchester. Service scheduling on co-op and condo buildings requires building-management coordination; some buildings maintain preferred-vendor lists that limit installer choice.`,
    permitRequirementsBody: `NYC permit requirements: DOB NOW e-permits issue within 48-72 hours for like-for-like swaps. Any header alteration requires PW1 plan review and adds 3-6 weeks. Expediter fees in Brooklyn and the Bronx run $450-$900 on top of the $200 filing fee. Parking-permit staging in Manhattan can add another $300 per day. Landmarked LPC districts require Certificate of No Effect before permit issues. Multi-family buildings additionally require DOB Tenant Protection Plans. HIC (Home Improvement Contractor) registration at nyc.gov/dca is mandatory for any work over $200.`,
  },
  "los-angeles-ca": {
    dealerLandscape: `LA local dealer landscape: Precision Door Service, Overhead Door of Southern California, and Quality Overhead Doors (Van Nuys) handle the bulk of LA residential. Sears Garage Doors exited LA in 2019, and Home Depot Expo closures eliminated the big-box full-service channel. Clopay and Amarr factory-direct rep coverage from California regional offices. Wayne Dalton and C.H.I. Overhead Doors serve higher-end custom market. LA Westside (Beverly Hills, Brentwood, Santa Monica) dealers include Martin Garage Doors Pacific and LA Overhead Door. Factory lead times to LA: 2-5 days stock, 8-14 days custom.`,
    permitRequirementsBody: `LA permit requirements: LADBS permits over-the-counter for like-for-like swaps at $220 base fee. Any header modification triggers plan check at 4-8 weeks. Historic Preservation Overlay Zones (HPOZ) in West Adams, Miracle Mile, and Angelino Heights add Cultural Heritage Commission review with 30-60 day cycles. California CSLB C-61 specialty license or B general required for any work over $500. California Coastal Commission jurisdiction adds 4-8 weeks on coastal-zone properties. California WUI Chapter 7A compliance documentation required in designated very-high-severity fire-hazard zones.`,
  },
  "chicago-il": {
    dealerLandscape: `Chicago local dealer landscape: Overhead Door Company of Joliet and Feldco (HQ Des Plaines) dominate the metro; North Shore Garage Doors handles the Wilmette and Winnetka premium market. Clopay and Amarr factory presence in Wisconsin means faster Chicago lead times (5-10 days) than coastal markets. LiftMaster regional rep coverage from Chicago-area office. Wayne Dalton and C.H.I. Overhead Doors serve higher-end custom market. Suburban contractors (Oak Park, Evanston, Naperville) often hold multiple municipal licenses. Factory lead times to Chicago: 2-4 days stock, 6-10 days custom.`,
    permitRequirementsBody: `Chicago permit requirements: City of Chicago DOB E-permits issue within 24-48 hours for swap-outs. Cook County suburban municipalities like Oak Park, Evanston, and Arlington Heights require in-person plan submittal and extend timelines 7-14 days. Chicago Building Code 18-27-302 requires fire-rated assemblies on any attached-garage door connecting to living space. Commission on Chicago Landmarks review applies to landmarked properties including Old Town, Pullman, Prairie Avenue. Chicago GC license required for city permit-pulling; Illinois has no statewide residential contractor license.`,
  },
  "houston-tx": {
    dealerLandscape: `Houston local dealer landscape: Overhead Door Corporation is headquartered in Lewisville TX and runs factory-direct installs across Houston. Action Overhead Door and A1 Garage Door Service split most volume market. Banko Overhead Doors handles premium River Oaks and Memorial tier with in-house wood shops. Clopay and Amarr ship through Texas distribution hubs. LiftMaster regional rep coverage from Texas office. Factory lead times to Houston: 1-3 days stock, 5-8 days custom. Post-Harvey 2017 and post-Beryl 2024 supply chain strains extended lead times 50-100% for 6-12 months.`,
    permitRequirementsBody: `Houston permit requirements: City of Houston permits residential door swaps same-day online. No inspection required inland of Beltway 8. Clear Lake, Kemah, Seabrook, and Galveston County installs require WPI-8 (Windstorm Protection Installation) certification before TWIA will bind windstorm coverage. Texas has no state-level roofing license but Houston relies on insurance verification and BBB complaint history. Harris County unincorporated uses Harris County Permit Office. Heights HAHC review applies to contributing structures.`,
  },
  "phoenix-az": {
    dealerLandscape: `Phoenix local dealer landscape: Martin Garage Doors is headquartered in Salt Lake City and dominates Phoenix through its dealer network. A1 Garage Door Service of Arizona and Prestige Garage Door round out the top three. Big-box Home Depot Mesa and Lowe's Paradise Valley subcontract to Prestige or A1 respectively. Clopay and Amarr factory direct rep coverage from California and Arizona regional offices. LiftMaster regional rep coverage from Arizona office. Factory lead times to Phoenix: 2-4 days stock, 6-10 days custom.`,
    permitRequirementsBody: `Phoenix permit requirements: City of Phoenix permits residential garage door swaps online for $47. Maricopa County unincorporated areas run $65-$120 depending on valuation. HOA ACC review often takes longer than the city permit itself, with Summerlin-style covenants requiring 10-21 day design submittal cycles. Arizona ROC license (CR-42 or KB-1) required for any work. Phoenix Historic Preservation Office review applies to Willo, Encanto-Palmcroft, Coronado on contributing structures.`,
  },
  "dallas-tx": {
    dealerLandscape: `Dallas local dealer landscape: Overhead Door Corporation (HQ Lewisville) runs a factory outlet on I-35E. Banko Overhead Doors and Action Garage Door DFW handle most volume residential work. Wayne Dalton's DFW showroom in Plano leads the carriage-house overlay tier with custom wood-shop capability. Clopay, Amarr, and C.H.I. Overhead Doors serve mid-range and premium segments. LiftMaster regional rep coverage from Texas office. Factory lead times to DFW: same-day or next-day stock, 5-8 days custom. Post-2019 and post-2023 hail events created 8-12 week lead-time surges.`,
    permitRequirementsBody: `Dallas permit requirements: City of Dallas permits online for $92 base minimum. Any header alteration triggers residential structural plan review at 2-4 weeks. Historic Districts (Munger Place, Winnetka Heights, Swiss Avenue) add Landmark Commission design review of 30-45 days for any street-visible material change. Suburban cities (Plano, Richardson, Irving, Arlington, Fort Worth, Frisco) use separate permit processes. Texas has no state-level roofing license so verification centers on insurance certificates and BBB history.`,
  },
  "atlanta-ga": {
    dealerLandscape: `Atlanta local dealer landscape: Overhead Door Company of Atlanta and Garage Door Pro run most volume residential installs. Precision Door Service and Clopay Atlanta dealer network handle mid-range and premium. Wayne Dalton and C.H.I. Overhead Doors serve custom market. LiftMaster regional rep coverage from Atlanta office. Atlas (headquartered in Atlanta) provides strong SE distribution support. Factory lead times to Atlanta: same-day or next-day stock on major brands, 6-10 days custom. AUDC historic-district work extends lead times 4-10 weeks for Commission review. Fulton, DeKalb, Cobb, Gwinnett, Clayton, Cherokee County dealers serve suburban residential. Buckhead and Sandy Springs premium tier handled by specialty dealers with custom-wood-shop capability.`,
    permitRequirementsBody: `Atlanta permit requirements: Atlanta Department of City Planning permits through ATLDOCS portal within 48-72 hours at $75 minimum. Fulton, DeKalb, Cobb, Gwinnett, Clayton counties use separate permit offices. Georgia Residential Basic Contractor license required for jobs over $2,500 (verifiable at sos.ga.gov). AUDC historic review applies to Inman Park, Grant Park, Virginia-Highland, Candler Park, Cabbagetown, Druid Hills, Ansley Park, Morningside, Reynoldstown. Landmark review adds 4-10 weeks.`,
  },
  "denver-co": {
    dealerLandscape: `Denver local dealer landscape: Overhead Door Company of Denver and Precision Door Service handle most volume residential installs. Clopay and Amarr factory-direct rep coverage from Rocky Mountain regional offices. Wayne Dalton and C.H.I. Overhead Doors serve custom and premium market. Stone-coated metal door specialty from Decra, Gerard distributors. LiftMaster regional rep coverage from Colorado office. Factory lead times to Denver: 2-4 days stock, 7-12 days custom. Post-hail 2017 and 2023 events created 8-14 week lead-time surges across Front Range.`,
    permitRequirementsBody: `Denver permit requirements: Denver Development Services permits through ePermit portal within 48-72 hours at $95 minimum. Arapahoe, Jefferson, Adams, Douglas counties use separate permit processes. Denver Class D (residential) Supervisor License required for permit-pulling (Colorado has no statewide residential contractor license). Denver Landmark Preservation Commission review applies to Capitol Hill, Country Club, Baker, Humboldt Street, Wyman on contributing structures. High-altitude installation considerations apply above 5,280 feet.`,
  },
  "seattle-wa": {
    dealerLandscape: `Seattle local dealer landscape: Precision Door Service Seattle, Overhead Door Company of Seattle, and A1 Garage Door Service handle most volume residential installs. Clopay and Amarr factory-direct rep coverage from Pacific Northwest regional offices. Wayne Dalton and C.H.I. Overhead Doors serve custom and premium market. LiftMaster regional rep coverage from Washington office. Factory lead times to Seattle: 3-5 days stock, 8-14 days custom. Rainy-season install scheduling creates seasonal demand concentration. Pierce, Snohomish, Kitsap County dealers serve suburban residential. Washington L&I registration status affects warranty enforceability; registered-at-bidding contractors whose registration lapses before completion forfeit surety recovery rights.`,
    permitRequirementsBody: `Seattle permit requirements: Seattle Department of Construction and Inspections (SDCI) permits through Accela portal within 5-10 business days at $180 minimum. King County unincorporated uses separate permits. Washington L&I contractor registration required for permit-pulling (bond amount varies by scope). Seattle Landmarks Preservation Board review applies to Pike Place Market, Pioneer Square, Harvard-Belmont, Ballard Avenue, Columbia City on contributing structures. Seattle Energy Code amendments require specific wall-assembly performance on major renovations. Pre-1978 homes require EPA RRP certified firms for any work disturbing lead paint. Cascadia earthquake seismic retrofit coordination affects structural-opening modifications. Coastal Commission-style jurisdiction does not apply but Washington State Shoreline Management applies on waterfront properties.`,
  },
  "austin-tx": {
    dealerLandscape: `Austin local dealer landscape: Overhead Door Company of Austin, Austin Garage Door Pro, and A1 Garage Door Service of Austin handle most volume residential installs. Clopay and Amarr factory-direct rep coverage from Texas regional office. Wayne Dalton's Austin showroom serves custom market. LiftMaster regional rep coverage from Texas office. Factory lead times to Austin: 1-3 days stock, 5-8 days custom. Post-Uri 2021 demand created 4-8 week lead-time surges. Austin's rapid growth drives higher-than-average new-construction demand vs replacement. Williamson and Hays County dealers serve suburban growth. West Austin limestone-faced home installations may require custom hardware orders.`,
    permitRequirementsBody: `Austin permit requirements: Austin Development Services Department permits through AB+C Portal within 48-72 hours at $85 minimum. Travis, Williamson, Hays counties use separate permit offices. City of Austin Registered Residential Building Contractor status required for permit-pulling (Texas has no state license). Austin Historic Landmark Commission review applies to Hyde Park, Travis Heights, Clarksville, Old West Austin, Rainey Street on contributing structures. Landmark review adds 4-8 weeks. Austin Energy Code (2022) requires specific cool-reflectance on low-slope portions of residential. Pre-1978 homes require EPA RRP certified firms. Williamson County suburban permit processes differ from Travis County on timing and fee structure.`,
  },
  "san-francisco-ca": {
    dealerLandscape: `SF local dealer landscape: Precision Door Service SF, Overhead Door of San Francisco, and R&S Erection handle most volume residential installs. Clopay and Amarr factory-direct rep coverage from California regional offices. Wayne Dalton and C.H.I. Overhead Doors serve custom market including Victorian restoration. LiftMaster regional rep coverage from California office. Factory lead times to SF: 2-4 days stock, 8-14 days custom. Victorian restoration and Mediterranean Revival custom-wood assemblies from specialty manufacturers with 4-8 week lead times.`,
    permitRequirementsBody: `SF permit requirements: SF Department of Building Inspection (DBI) permits through Permit Center within 5-10 business days at $285 minimum. California CSLB license mandatory (C-61 specialty or B general). SF DBI additionally requires city contractor registration. SF Historic Preservation Commission review applies to 270+ landmarks and 11 historic districts. SF lead-safe renovation rules (pre-1978 homes) require EPA RRP certification. SF dust-control ordinance §3428 imposes HEPA-vacuum cleanup verification.`,
  },
  "las-vegas-nv": {
    dealerLandscape: `Vegas local dealer landscape: Overhead Door Company of Las Vegas and Precision Door Service handle most volume residential installs. Clopay and Amarr factory-direct rep coverage from California regional offices. Wayne Dalton and C.H.I. Overhead Doors serve custom market. LiftMaster regional rep coverage from Nevada office. Factory lead times to Vegas: 2-4 days stock, 7-12 days custom. Master-planned community (Summerlin, Anthem, MacDonald Ranch) volume drives distribution network density. Strip-adjacent commercial and specialty hardware suppliers serve luxury market.`,
    permitRequirementsBody: `Vegas permit requirements: Clark County Building Department permits through online portal within 48-72 hours at $75 minimum. City of Las Vegas, Henderson, North Las Vegas, Boulder City use separate permit processes. Nevada C-15 roofing license or C-17 plastering license required for specialty work; C-8 glazing for window-related scope. HOA architectural approval in Summerlin, Anthem, MacDonald Ranch, Seven Hills is often more time-consuming than county permit. NRS §624.6245 caps residential contractor deposits at 10% of contract or $1,000.`,
  },
  "philadelphia-pa": {
    dealerLandscape: `Philadelphia local dealer landscape: Overhead Door Company of Greater Philadelphia and Precision Door Service handle most volume residential installs. Clopay and Amarr factory-direct rep coverage from mid-Atlantic regional offices. Wayne Dalton and C.H.I. Overhead Doors serve custom market including Chestnut Hill restoration. LiftMaster regional rep coverage from Pennsylvania office. Factory lead times to Philly: 1-3 days stock, 6-10 days custom. Rowhouse specialty and tuck-under garage configurations require specialty installer expertise. Montgomery, Chester, Bucks, and Delaware County dealers serve suburban residential with favorable lead times. Historical Commission-approved restoration work has limited qualified installer pool.`,
    permitRequirementsBody: `Philadelphia permit requirements: Philadelphia L&I permits through ePLAN portal within 5-7 business days at $150 minimum. Pennsylvania HICPA registration plus Philadelphia city Contractor License both required on contract. Philadelphia Historical Commission review applies to 18,000+ historic structures and 20+ designated districts. Landmark review adds 6-12 weeks. Rowhouse adjacent-property scaffold agreements through PDE add 2-3 weeks. Lead-painted substrates on pre-1978 homes trigger EPA RRP scope plus PA-specific lead hazard requirements. Delaware River flood-zone properties require specific elevation and flood-resistant detailing. Rowhouse party-wall coordination with adjacent property owners affects permit scope on shared facades.`,
  },
  "miami-fl": {
    dealerLandscape: `Miami local dealer landscape: Overhead Door Corporation of Miami, Precision Door Service, and Hurricane-Rated Door Specialists handle most volume residential installs. Clopay HVHZ-approved products and Amarr factory-direct rep coverage from Florida regional offices. Wayne Dalton and C.H.I. Overhead Doors serve custom market including Coral Gables Merrick-era restoration. LiftMaster regional rep coverage from Florida office. Factory lead times to Miami: 3-7 days stock, 10-16 days custom. Hurricane-season supply chain strains extend lead times 50-100% for 6-12 months post-event. Miami-Dade NOA-approved specialty dealers focus exclusively on HVHZ-compliant products. Broward and Palm Beach County dealers serve regional residential with similar HVHZ requirements.`,
    permitRequirementsBody: `Miami permit requirements: Miami-Dade Building Department permits through ePlan portal within 7-14 business days at $250 minimum plus NOA documentation verification. Broward County uses separate permits. Florida DBPR Certified Specialty Contractor (C-22) or Certified General Contractor license required. Every door installed in Miami-Dade and Broward must have current NOA documentation; NOA number must appear on permit and final inspection card. Coral Gables, Miami Beach, MiMo historic review adds 6-14 weeks on contributing properties. Florida Statute §627.7152 governs AOB rescission with 14-day window. Palm Beach County uses separate permit processes with similar HVHZ requirements.`,
  },
  "boston-ma": {
    dealerLandscape: `Boston local dealer landscape: Overhead Door Company of Boston and Precision Door Service handle most volume residential installs. Clopay and Amarr factory-direct rep coverage from New England regional offices. Wayne Dalton and C.H.I. Overhead Doors serve custom market including Back Bay and Beacon Hill restoration. LiftMaster regional rep coverage from Massachusetts office. Factory lead times to Boston: 2-5 days stock, 8-12 days custom. Triple-decker installation specialty crews operate with multi-story scaffold expertise. Middlesex, Norfolk, Essex, Plymouth County dealers serve suburban residential. Cambridge, Brookline, Newton premium tier handled by specialty dealers with landmark-approved restoration capability.`,
    permitRequirementsBody: `Boston permit requirements: Boston Inspectional Services Department permits through Permit Center portal within 5-10 business days at $200 minimum. Massachusetts HIC registration plus Construction Supervisor License (CSL) both required for structural opening work. Boston Landmarks Commission review applies to Back Bay, Beacon Hill, Fort Point, South End, Bay Village. Landmark review adds 6-10 weeks. Massachusetts Stretch Code applies in Boston plus most inner-ring suburbs. Lead-painted substrates on pre-1978 homes trigger EPA RRP plus MA Deleading regulations.`,
  },
  "san-diego-ca": {
    dealerLandscape: `San Diego local dealer landscape: Overhead Door Company of San Diego and Precision Door Service handle most volume residential installs. Clopay and Amarr factory-direct rep coverage from California regional offices. Wayne Dalton and C.H.I. Overhead Doors serve custom market including La Jolla and Rancho Santa Fe coastal-grade installations. LiftMaster regional rep coverage from California office. Factory lead times to SD: 2-4 days stock, 8-14 days custom. Coastal-adjacent specialty (stainless-steel hardware, marine-coated components) available from select dealers.`,
    permitRequirementsBody: `San Diego permit requirements: San Diego Development Services Department permits through DSD portal within 5-10 business days at $195 minimum. County of San Diego unincorporated uses separate permits. California CSLB C-61 specialty or B general license mandatory. San Diego Historic Resources Board review applies to Mills Act properties and historic neighborhoods. California WUI Chapter 7A compliance mandatory in designated very-high-severity fire-hazard zones. California Coastal Commission jurisdiction adds 4-8 weeks on coastal-zone properties.`,
  },
  "tampa-fl": {
    dealerLandscape: `Tampa local dealer landscape: Overhead Door Corporation of Tampa, Precision Door Service, and FPA-Rated Door Specialists handle most volume residential installs. Clopay FPA-approved products and Amarr factory-direct rep coverage from Florida regional offices. Wayne Dalton and C.H.I. Overhead Doors serve custom market. LiftMaster regional rep coverage from Florida office. Factory lead times to Tampa: 2-5 days stock, 8-14 days custom. Hurricane-season supply chain strains extend lead times 50-100% for 6-12 months post-event. Pinellas County dealers serve St. Pete Beach, Clearwater, and Dunedin coastal-zone properties with specialized FPA-approved inventory. Tampa has strong Hillsborough and Pinellas coverage with competitive pricing.`,
    permitRequirementsBody: `Tampa permit requirements: Tampa-Hillsborough County Building Department permits through Electronic Plans Review (ePRS) portal within 7-14 business days at $175 minimum plus FPA documentation verification. Pinellas County uses separate permits. Florida DBPR Certified Specialty Contractor (C-22) or Certified General Contractor license required. Tampa Historic Preservation review applies to Hyde Park, Seminole Heights, Tampa Heights, Ybor City on contributing structures. Wind-borne debris region installations require documented FPA approval. Florida Statute §627.7152 governs AOB rescission with 14-day window. Pinellas County coastal-adjacent installations add additional coastal wind-zone permit requirements. Hurricane-season active-storm warnings may suspend active permit work.`,
  },
  "detroit-mi": {
    dealerLandscape: `Detroit local dealer landscape: Overhead Door Company of Detroit and Precision Door Service handle most volume residential installs. Clopay and Amarr factory-direct rep coverage from Midwest regional offices. Wayne Dalton and C.H.I. Overhead Doors serve custom market including Boston-Edison and Indian Village restoration. LiftMaster regional rep coverage from Michigan office. Factory lead times to Detroit: 2-4 days stock, 7-12 days custom. Post-2023 derecho recovery extended lead times 3-6 weeks across Oakland and Macomb counties. Wayne, Oakland, Macomb, Washtenaw County dealers serve suburban residential. Grosse Pointe and Birmingham premium tier handled by specialty dealers with custom-wood-shop capability.`,
    permitRequirementsBody: `Detroit permit requirements: City of Detroit Buildings, Safety Engineering, and Environmental Department permits within 5-10 business days at $100 minimum. Wayne, Oakland, Macomb counties use separate permit processes. Michigan LARA Residential Builder license required for permit-pulling. Detroit Historic Designation Advisory Board review applies to Boston-Edison, Indian Village, Woodbridge, Palmer Park, Corktown. Landmark review adds 4-8 weeks. Michigan Consumer Protection Act MCL §339.2411 requires three-day right-of-rescission on in-home sales. Pre-1978 homes require EPA RRP certified firms. Michigan also has specific lead-abatement licensing requirements on residential property.`,
  },
  "minneapolis-mn": {
    dealerLandscape: `Minneapolis local dealer landscape: Overhead Door Company of Minneapolis and Precision Door Service handle most volume residential installs. Clopay and Amarr factory-direct rep coverage from Midwest regional offices. Wayne Dalton and C.H.I. Overhead Doors serve custom market including historic restoration. LiftMaster regional rep coverage from Minnesota office. Marvin and Andersen window coordination on combined envelope projects is routine. Factory lead times to Twin Cities: same-day or next-day stock on major brands (CertainTeed Shakopee plant adjacent), 5-10 days custom. Hennepin, Ramsey, Dakota, Anoka, Washington County dealers serve suburban residential. Edina, Wayzata, Lake Minnetonka premium tier handled by specialty dealers.`,
    permitRequirementsBody: `Minneapolis permit requirements: Minneapolis Development Services permits through Minneapolis ePlans portal within 5-10 business days at $175 minimum. St. Paul uses separate permits. Minnesota LARA Residential Building Contractor license required for jobs over $15,000. Minneapolis additionally requires city contractor registration. Minneapolis Heritage Preservation Commission review applies to Milwaukee Avenue, Nicollet Island, Healy Block, Fourth Avenue Historic District, Stevens Square, Fulton. Landmark review adds 4-8 weeks. Minnesota Energy Code mandates air-leakage verification.`,
  },
  "charlotte-nc": {
    dealerLandscape: `Charlotte local dealer landscape: Overhead Door Company of Charlotte and Aaron Overhead Doors of Charlotte handle most volume residential installs. Precision Door Service and Garage Door Pro round out top volume. Clopay and Amarr factory-direct rep coverage from Southeast regional offices. Wayne Dalton and C.H.I. Overhead Doors serve custom market. LiftMaster regional rep coverage from North Carolina office. Factory lead times to Charlotte: 1-3 days stock, 5-10 days custom. Charlotte is a regional distribution hub with favorable lead times for mid-Atlantic and Southeast distribution. Cabarrus, Gaston, Iredell, Union, York SC counties served by same regional dealers. Post-hail-event recovery years extend lead times 2-4 weeks across the Piedmont.`,
    permitRequirementsBody: `Charlotte permit requirements: Charlotte-Mecklenburg Planning Services permits through Accela portal within 5-10 business days at $150 minimum. Cabarrus, Gaston, Iredell, Union counties use separate permit processes. North Carolina Licensing Board for General Contractors license required for jobs over $30,000 (verifiable at nclbgc.org); Mecklenburg County contractor registration for smaller jobs. Charlotte-Mecklenburg Historic District Commission review applies to Dilworth, Wesley Heights, Fourth Ward, Plaza Midwood, Wilmore. Landmark review adds 4-8 weeks. North Carolina Residential Code amendments post-Florence 2018 and post-2020 severe-weather outbreak require enhanced wind-uplift specifications. Pre-1978 homes require EPA RRP certified firms.`,
  },
};

for (const slug in CITY_GARAGE_EXTRA4) {
  Object.assign(CITY_GARAGE_DATA[slug], CITY_GARAGE_EXTRA4[slug]);
}
...
function windCodeSection(city, g) {
  if (!g.windCodeRatings) return "";
  return `
<section ${SECSTYLE}>
<h2 ${H2STYLE}>Wind-Code Ratings and Structural Specs in ${city}</h2>
<p ${PSTYLE}>${g.windCodeRatings}</p>
</section>`;
}
function hoaStyleSection(city, g) {
  if (!g.HOAColorStyleRules) return "";
  return `
<section ${SECSTYLE}>
<h2 ${H2STYLE}>${city} HOA and Historic-District Color and Style Rules</h2>
<p ${PSTYLE}>${g.HOAColorStyleRules}</p>
</section>`;
}
function servicePricingSection(city, g) {
  if (!g.serviceCallPricing) return "";
  return `
<section ${SECSTYLE}>
<h2 ${H2STYLE}>${city} Service-Call and Repair Pricing</h2>
<p ${PSTYLE}>${g.serviceCallPricing}</p>
</section>`;
}
function weatherSealSection(city, g) {
  if (!g.weatherSealSpec) return "";
  return `
<section ${SECSTYLE}>
<h2 ${H2STYLE}>${city} Weather-Seal Specification</h2>
<p ${PSTYLE}>${g.weatherSealSpec}</p>
</section>`;
}
function springCableSection(city, g) {
  if (!g.springAndCable) return "";
  return `
<section ${SECSTYLE}>
<h2 ${H2STYLE}>${city} Spring and Cable Systems</h2>
<p ${PSTYLE}>${g.springAndCable}</p>
</section>`;
}
function smartHomeSection(city, g) {
  if (!g.smartHomeIntegration) return "";
  return `
<section ${SECSTYLE}>
<h2 ${H2STYLE}>${city} Smart-Home Integration</h2>
<p ${PSTYLE}>${g.smartHomeIntegration}</p>
</section>`;
}
function dealerLandscapeSection(city, g) {
  if (!g.dealerLandscape) return "";
  return `
<section ${SECSTYLE}>
<h2 ${H2STYLE}>${city} Dealer Landscape and Lead Times</h2>
<p ${PSTYLE}>${g.dealerLandscape}</p>
</section>`;
}
function permitsDeepSection(city, g) {
  if (!g.permitRequirementsBody) return "";
  return `
<section ${SECSTYLE}>
<h2 ${H2STYLE}>${city} Permit Requirements and Licensing</h2>
<p ${PSTYLE}>${g.permitRequirementsBody}</p>
</section>`;
}
...
function buildFlagshipContent(metro) {
  ...
  html += hoaStyleSection(city, g);
  html += insulationSection(city, g);
  html += weatherSealSection(city, g);
  html += openerSection(city, g);
  html += smartHomeSection(city, g);
  html += springCableSection(city, g);
  html += codeDealerSection(city, g, facts, ctx);
  html += dealerLandscapeSection(city, g);
  html += permitsDeepSection(city, g);
  html += windCodeSection(city, g);
  html += servicePricingSection(city, g);
