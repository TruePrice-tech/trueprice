...
const CITY_GARAGE_DATA = {
  ...
  "milwaukee-wi": {
    archIntro: "Milwaukee garage architecture reflects the region's housing stock and climate.",
    archBody: "Homes in Third Ward and Bay View typically feature attached two-car garages with insulated steel doors designed for cold-weather performance. Wauwatosa properties may have detached or oversized three-car configurations.",
    insulationIntro: "Garage door insulation in Milwaukee is driven by severe winter heating loads.",
    insulationBody: "Polyurethane-injected steel doors with R-18 to R-22 values are the standard Milwaukee specification because attached garages share walls with conditioned space.",
    openerBody: "Milwaukee homeowners commonly install LiftMaster or Chamberlain belt-drive openers with Wi-Fi connectivity and battery backup. Battery backup is particularly important given winter storm power outages. Chain-drive openers remain popular in detached garages where noise is less of a concern.",
    codeBody: "City of Milwaukee Department of Neighborhood Services handles garage door replacement permits when structural headers or opening dimensions change. Local energy codes may require minimum insulation values on attached-garage doors.",
    dealerBody: "Clopay, Amarr, and Wayne Dalton are the major brands distributed through Milwaukee dealers. Third Ward and Wauwatosa have strong local dealer networks offering Overhead Door and C.H.I. products. Specialty carriage-house and custom wood doors are available through regional distributors.",
    stormBody: "Milwaukee winter storms with ice and heavy snow load stress garage door springs and tracks. Annual maintenance inspection is recommended before November.",
    redFlag1: "Bid does not specify door manufacturer, model, or R-value",
    redFlag2: "No mention of spring type (torsion vs. extension) or cycle rating",
    redFlag3: "Opener quote omits battery backup and smart-home integration options",
    redFlag4: "Installer cannot provide proof of manufacturer certification",
    redFlag5: "Door insulation R-value is below R-12 on an attached garage in a cold climate",
    scenarios: "Budget single-car non-insulated steel door replacement in Milwaukee runs $800-$1,400 installed. Mid-range insulated two-car steel door with windows and new opener runs $2,200-$3,800. Premium carriage-house style with R-18 polyurethane core and smart opener runs $4,500-$7,500.",
    seasonalBest: "September-November and March-May",
    seasonalWorst: "December-February (emergency repairs from spring failures) and June-August (peak demand)",
    seasonalNote: "Milwaukee garage door installers are busiest during spring when winter damage drives replacement demand. Off-season scheduling saves 8-15% on labor. Emergency spring replacement after failure commands premium pricing year-round."
  },
