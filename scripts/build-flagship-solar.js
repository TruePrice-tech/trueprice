#!/usr/bin/env node
/**
 * Generates deep editorial content for 40 flagship metro solar pages.
...
const METROS = [
  ...
  { slug: "charlotte-nc", ctxKey: "Charlotte|NC", file: "charlotte-nc-solar-cost.html", region: "southeast" },
    ...
    { slug: "jacksonville-fl", ctxKey: "Jacksonville|FL", file: "jacksonville-fl-solar-cost.html", region: "southeast" },
    { slug: "fort-worth-tx", ctxKey: "Fort Worth|TX", file: "fort-worth-tx-solar-cost.html", region: "south" },
    ...
    { slug: "memphis-tn", ctxKey: "Memphis|TN", file: "memphis-tn-solar-cost.html", region: "southeast" },
    { slug: "louisville-ky", ctxKey: "Louisville|KY", file: "louisville-ky-solar-cost.html", region: "southeast" },
    { slug: "baltimore-md", ctxKey: "Baltimore|MD", file: "baltimore-md-solar-cost.html", region: "northeast" },
    { slug: "milwaukee-wi", ctxKey: "Milwaukee|WI", file: "milwaukee-wi-solar-cost.html", region: "midwest" },
    { slug: "albuquerque-nm", ctxKey: "Albuquerque|NM", file: "albuquerque-nm-solar-cost.html", region: "mountain" },
    { slug: "tucson-az", ctxKey: "Tucson|AZ", file: "tucson-az-solar-cost.html", region: "mountain" },
    { slug: "sacramento-ca", ctxKey: "Sacramento|CA", file: "sacramento-ca-solar-cost.html", region: "west" },
    { slug: "raleigh-nc", ctxKey: "Raleigh|NC", file: "raleigh-nc-solar-cost.html", region: "southeast" },
    ...
    { slug: "cincinnati-oh", ctxKey: "Cincinnati|OH", file: "cincinnati-oh-solar-cost.html", region: "midwest" },
    { slug: "colorado-springs-co", ctxKey: "Colorado Springs|CO", file: "colorado-springs-co-solar-cost.html", region: "mountain" },
];
...
const SOLAR_DATA = {
  ...
  "jacksonville-fl": {
    ...
    bestInstallMonth: "October-February",
    sunPara: "Jacksonville averages 4.8 peak sun hours daily with strong seasonal production variation. Afternoon thunderstorms from June through September clip 10-15% off theoretical summer production. Riverside and Ponte Vedra Beach receive varying insolation based on tree coverage and building orientation.",
    tariffPara: "Jacksonville operates under Florida net metering rules with 1-for-1 retail-rate credits for exported energy.",
    interconnectPara: "JEA interconnection for residential systems runs 4-12 weeks depending on system size and feeder capacity. City of Jacksonville Building Inspection Division issues the electrical and building permits. Riverside and Ponte Vedra Beach may have different hosting capacity on their local feeders.",
    installerLandscapePara: "The Jacksonville installer market includes national players (Sunrun, Tesla Energy, Freedom Forever) and strong regional firms. State electrical contractor licensing applies. Typical Jacksonville residential quote runs $2.80-$3.60 per watt before incentives.",
    ...
    roofLandscapePara: "Jacksonville rooftop stock is primarily concrete tile and composition shingle, with tile requiring specialty mounting hardware that adds 15-25% to installation cost. Riverside roof types may differ from Ponte Vedra Beach based on construction era.",
    hoaAndRestrictPara: "Florida statute 163.04 prevents HOAs from prohibiting solar installations. Master-planned communities in Ponte Vedra Beach may have architectural review requirements that delay but cannot prevent installation.",
    permitProcessPara: "City of Jacksonville Building Inspection Division issues solar permits through the online portal in 1-3 weeks for standard residential installs. Riverside historic district parcels may require additional preservation review. ",
    batteryPara: "Battery storage in Jacksonville is driven primarily by hurricane-season outage resilience. Tesla Powerwall 3 and Enphase IQ Battery are the dominant residential products. Federal ITC applies to battery storage paired with solar.",
    climateRiskPara: "Jacksonville solar climate risks include hurricane wind uplift exceeding 150 mph design loads, coastal salt spray corrosion, and summer lightning. Module racking must be spec'd for the local wind and snow load zone. Florida Product Approval is required for all mounting hardware.",
    timelinePara: "Full timeline from contract to Permission to Operate in Jacksonville runs 8-16 weeks: site assessment, permitting, installation, inspection, and utility interconnection. The October-February installation window targets peak production months.",
    uniqueInsightPara: "Jacksonville's solar market benefits from strong net metering and state tax exemptions that improve payback. JEA utility programs shape the local incentive landscape."
  },
  ...
  "fort-worth-tx": {
    ...
    bestInstallMonth: "October-February",
    sunPara: "Fort Worth averages 4.8 peak sun hours daily with strong seasonal production variation. Production peaks June through August and drops in winter months. Southlake and Fairmount receive varying insolation based on tree coverage and building orientation.",
    tariffPara: "Fort Worth operates in the deregulated ERCOT retail market. No statewide net metering mandate exists. Solar buyback plans from retail providers credit exported energy at $0.04-$0.09 per kWh against retail rates.",
    interconnectPara: "Oncor Electric Delivery interconnection for residential systems runs 4-12 weeks depending on system size and feeder capacity. City of Fort Worth Development Services issues the electrical and building permits. Southlake and Fairmount may have different hosting capacity on their local feeders.",
    installerLandscapePara: "The Fort Worth installer market includes national players (Sunrun, Tesla Energy, Freedom Forever) and strong regional firms. Texas TDLR electrical contractor license is required. Typical Fort Worth residential quote runs $2.80-$3.60 per watt before incentives.",
    incentivesPara: "The 30% federal Investment Tax Credit (Section 25D) is the anchor incentive. Texas offers no state tax credit or rebate; the federal ITC plus local utility buyback rates drive economics. Combined incentives can reduce a $24,000 system to $12,000-$16,000 effective cost.",
    roofLandscapePara: "Fort Worth rooftop stock is primarily composition shingle with flat-membrane on commercial-adjacent multifamily. Southlake roof types may differ from Fairmount based on construction era.",
    hoaAndRestrictPara: "Texas Property Code Section 202.010 prevents HOAs from prohibiting solar but allows reasonable placement restrictions. Master-planned communities in Fairmount may have architectural review requirements that delay but cannot prevent installation.",
    permitProcessPara: "City of Fort Worth Development Services issues solar permits through the online portal in 1-3 weeks for standard residential installs. Southlake historic district parcels may require additional preservation review. ",
    batteryPara: "Battery storage in Fort Worth is driven primarily by ERCOT grid reliability concerns after Winter Storm Uri. Tesla Powerwall 3 and Enphase IQ Battery are the dominant residential products. Federal ITC applies to battery storage paired with solar.",
    climateRiskPara: "Fort Worth solar climate risks include seasonal severe weather and occasional hail. Module racking must be spec'd for the local wind and snow load zone. ",
    timelinePara: "Full timeline from contract to Permission to Operate in Fort Worth runs 8-16 weeks: site assessment, permitting, installation, inspection, and utility interconnection. The October-February installation window targets peak production months.",
    uniqueInsightPara: "Fort Worth's solar market benefits from competitive retail electricity rates that shape the self-consumption optimization strategy. Oncor Electric Delivery competitive retail providers shape the local incentive landscape."
  },
  ...
  "memphis-tn": {
    ...
    bestInstallMonth: "October-February",
    sunPara: "Memphis averages 4.2 peak sun hours daily with strong seasonal production variation. Production peaks June through August and drops in winter months. Midtown and Germantown receive varying insolation based on tree coverage and building orientation.",
    tariffPara: "Memphis residential solar operates under the state's net metering framework with Memphis Light, Gas and Water handling interconnection.",
    interconnectPara: "Memphis Light, Gas and Water interconnection for residential systems runs 4-12 weeks depending on system size and feeder capacity. City of Memphis Division of Planning and Development issues the electrical and building permits. Midtown and Germantown may have different hosting capacity on their local feeders.",
    installerLandscapePara: "The Memphis installer market includes national players (Sunrun, Tesla Energy, Freedom Forever) and strong regional firms. State electrical contractor licensing applies. Typical Memphis residential quote runs $2.80-$3.60 per watt before incentives.",
    incentivesPara: "The 30% federal Investment Tax Credit (Section 25D) is the anchor incentive. State-level incentives vary; check with Memphis Light, Gas and Water for current rebate programs. Combined incentives can reduce a $24,000 system to $12,000-$16,000 effective cost.",
    roofLandscapePara: "Memphis rooftop stock is primarily composition shingle with flat-membrane on commercial-adjacent multifamily. Midtown roof types may differ from Germantown based on construction era.",
    hoaAndRestrictPara: "Memphis HOA restrictions on solar vary; review CC&Rs carefully. Master-planned communities in Germantown may have architectural review requirements that delay but cannot prevent installation.",
    permitProcessPara: "City of Memphis Division of Planning and Development issues solar permits through the online portal in 1-3 weeks for standard residential installs. Midtown historic district parcels may require additional preservation review. ",
    batteryPara: "Battery storage in Memphis is driven primarily by resilience and potential time-of-use rate arbitrage. Tesla Powerwall 3 and Enphase IQ Battery are the dominant residential products. Federal ITC applies to battery storage paired with solar.",
    climateRiskPara: "Memphis solar climate risks include seasonal severe weather and occasional hail. Module racking must be spec'd for the local wind and snow load zone. ",
    timelinePara: "Full timeline from contract to Permission to Operate in Memphis runs 8-16 weeks: site assessment, permitting, installation, inspection, and utility interconnection. The October-February installation window targets peak production months.",
    uniqueInsightPara: "Memphis's solar market benefits from favorable solar resource and improving economics as equipment costs decline. Memphis Light, Gas and Water utility programs shape the local incentive landscape."
  },

  "louisville-ky": {
    peakSunHours: 4.2,
    paybackYears: "7-10 years",
    utility: "Louisville Gas and Electric (LG&E)",
    bestInstallMonth: "March-May",
    sunPara: "Louisville averages 4.2 peak sun hours daily with strong seasonal production variation. Production peaks June through August and drops in winter months. Highlands and St. Matthews receive varying insolation based on tree coverage and building orientation.",
    tariffPara: "Louisville residential solar operates under the state's net metering framework with Louisville Gas and Electric handling interconnection.",
    interconnectPara: "Louisville Gas and Electric interconnection for residential systems runs 4-12 weeks depending on system size and feeder capacity. Louisville Metro Department of Codes and Regulations issues the electrical and building permits. Highlands and St. Matthews may have different hosting capacity on their local feeders.",
    installerLandscapePara: "The Louisville installer market includes national players (Sunrun, Tesla Energy, Freedom Forever) and strong regional firms. State electrical contractor licensing applies. Typical Louisville residential quote runs $2.80-$3.60 per watt before incentives.",
    incentivesPara: "The 30% federal Investment Tax Credit (Section 25D) is the anchor incentive. State-level incentives vary; check with Louisville Gas and Electric for current rebate programs. Combined incentives can reduce a $24,000 system to $12,000-$16,000 effective cost.",
    roofLandscapePara: "Louisville rooftop stock is primarily composition shingle with flat-membrane on commercial-adjacent multifamily. Highlands roof types may differ from St. Matthews based on construction era.",
    hoaAndRestrictPara: "Louisville HOA restrictions on solar vary; review CC&Rs carefully. Master-planned communities in St. Matthews may have architectural review requirements that delay but cannot prevent installation.",
    permitProcessPara: "Louisville Metro Department of Codes and Regulations issues solar permits through the online portal in 1-3 weeks for standard residential installs. Highlands historic district parcels may require additional preservation review. ",
    batteryPara: "Battery storage in Louisville is driven primarily by resilience and potential time-of-use rate arbitrage. Tesla Powerwall 3 and Enphase IQ Battery are the dominant residential products. Federal ITC applies to battery storage paired with solar.",
    climateRiskPara: "Louisville solar climate risks include seasonal severe weather and occasional hail. Module racking must be spec'd for the local wind and snow load zone. ",
    timelinePara: "Full timeline from contract to Permission to Operate in Louisville runs 8-16 weeks: site assessment, permitting, installation, inspection, and utility interconnection. The March-May installation window targets peak production months.",
    uniqueInsightPara: "Louisville's solar market benefits from favorable solar resource and improving economics as equipment costs decline. Louisville Gas and Electric utility programs shape the local incentive landscape."
  },
  ...
  "baltimore-md": {
    ...
    bestInstallMonth: "March-May",
    sunPara: "Baltimore averages 3.8 peak sun hours daily with strong seasonal production variation. Winter production drops to 1.8-2.5 kWh per kW per day because of shortened days and cloud cover. Federal Hill and Roland Park receive varying insolation based on tree coverage and building orientation.",
    tariffPara: "Baltimore residential solar operates under the state's net metering framework with Baltimore Gas and Electric handling interconnection.",
    interconnectPara: "Baltimore Gas and Electric interconnection for residential systems runs 4-12 weeks depending on system size and feeder capacity. Baltimore City Department of Housing issues the electrical and building permits. Federal Hill and Roland Park may have different hosting capacity on their local feeders.",
    installerLandscapePara: "The Baltimore installer market includes national players (Sunrun, Tesla Energy, Freedom Forever) and strong regional firms. State electrical contractor licensing applies. Typical Baltimore residential quote runs $3.20-$4.00 per watt before incentives.",
    incentivesPara: "The 30% federal Investment Tax Credit (Section 25D) is the anchor incentive. State-level incentives vary; check with Baltimore Gas and Electric for current rebate programs. Combined incentives can reduce a $24,000 system to $12,000-$16,000 effective cost.",
    roofLandscapePara: "Baltimore rooftop stock is primarily composition shingle with some slate and flat-membrane on older homes. Federal Hill roof types may differ from Roland Park based on construction era.",
    hoaAndRestrictPara: "Baltimore HOA restrictions on solar vary; review CC&Rs carefully. Master-planned communities in Roland Park may have architectural review requirements that delay but cannot prevent installation.",
    permitProcessPara: "Baltimore City Department of Housing issues solar permits through the standard plan review process in 2-6 weeks. Federal Hill historic district parcels may require additional preservation review. ",
    batteryPara: "Battery storage in Baltimore is driven primarily by winter storm outage protection. Tesla Powerwall 3 and Enphase IQ Battery are the dominant residential products. Federal ITC applies to battery storage paired with solar.",
    climateRiskPara: "Baltimore solar climate risks include snow loading, wind uplift during winter storms, and hail damage. Module racking must be spec'd for the local wind and snow load zone. ",
    timelinePara: "Full timeline from contract to Permission to Operate in Baltimore runs 14-22 weeks: site assessment, permitting, installation, inspection, and utility interconnection. The March-May installation window targets peak production months.",
    uniqueInsightPara: "Baltimore's solar market benefits from growing cold-climate solar adoption as panel efficiency improves. Baltimore Gas and Electric utility programs shape the local incentive landscape."
  },

  "milwaukee-wi": {
    peakSunHours: 3.8,
    paybackYears: "8-11 years",
    utility: "We Energies (Wisconsin Energy)",
    bestInstallMonth: "March-May",
    sunPara: "Milwaukee averages 3.8 peak sun hours daily with strong seasonal production variation. Winter production drops to 1.8-2.5 kWh per kW per day because of shortened days and cloud cover. Third Ward and Wauwatosa receive varying insolation based on tree coverage and building orientation.",
    tariffPara: "Milwaukee residential solar operates under the state's net metering framework with We Energies handling interconnection.",
    interconnectPara: "We Energies interconnection for residential systems runs 4-12 weeks depending on system size and feeder capacity. City of Milwaukee Department of Neighborhood Services issues the electrical and building permits. Third Ward and Wauwatosa may have different hosting capacity on their local feeders.",
    installerLandscapePara: "The Milwaukee installer market includes national players (Sunrun, Tesla Energy, Freedom Forever) and strong regional firms. State electrical contractor licensing applies. Typical Milwaukee residential quote runs $2.80-$3.60 per watt before incentives.",
    incentivesPara: "The 30% federal Investment Tax Credit (Section 25D) is the anchor incentive. State-level incentives vary; check with We Energies for current rebate programs. Combined incentives can reduce a $24,000 system to $12,000-$16,000 effective cost.",
    roofLandscapePara: "Milwaukee rooftop stock is primarily composition shingle with some slate and flat-membrane on older homes. Third Ward roof types may differ from Wauwatosa based on construction era.",
    hoaAndRestrictPara: "Milwaukee HOA restrictions on solar vary; review CC&Rs carefully. Master-planned communities in Wauwatosa may have architectural review requirements that delay but cannot prevent installation.",
    permitProcessPara: "City of Milwaukee Department of Neighborhood Services issues solar permits through the online portal in 1-3 weeks for standard residential installs. Third Ward historic district parcels may require additional preservation review. ",
    batteryPara: "Battery storage in Milwaukee is driven primarily by winter storm outage protection. Tesla Powerwall 3 and Enphase IQ Battery are the dominant residential products. Federal ITC applies to battery storage paired with solar.",
    climateRiskPara: "Milwaukee solar climate risks include snow loading, wind uplift during winter storms, and hail damage. Module racking must be spec'd for the local wind and snow load zone. ",
    timelinePara: "Full timeline from contract to Permission to Operate in Milwaukee runs 8-16 weeks: site assessment, permitting, installation, inspection, and utility interconnection. The March-May installation window targets peak production months.",
    uniqueInsightPara: "Milwaukee's solar market benefits from growing cold-climate solar adoption as panel efficiency improves. We Energies utility programs shape the local incentive landscape."
  },
  ...
  "albuquerque-nm": {
    ...
    bestInstallMonth: "March-May",
    sunPara: "Albuquerque averages 5.5 peak sun hours daily with strong seasonal production variation. High-altitude clear skies deliver excellent solar resource year-round. Nob Hill and Rio Rancho receive varying insolation based on tree coverage and building orientation.",
    tariffPara: "Albuquerque residential solar operates under the state's net metering framework with PNM handling interconnection.",
    interconnectPara: "PNM interconnection for residential systems runs 4-12 weeks depending on system size and feeder capacity. City of Albuquerque Planning Department issues the electrical and building permits. Nob Hill and Rio Rancho may have different hosting capacity on their local feeders.",
    installerLandscapePara: "The Albuquerque installer market includes national players (Sunrun, Tesla Energy, Freedom Forever) and strong regional firms. State electrical contractor licensing applies. Typical Albuquerque residential quote runs $2.80-$3.60 per watt before incentives.",
    incentivesPara: "The 30% federal Investment Tax Credit (Section 25D) is the anchor incentive. State-level incentives vary; check with PNM for current rebate programs. Combined incentives can reduce a $24,000 system to $12,000-$16,000 effective cost.",
    roofLandscapePara: "Albuquerque rooftop stock is primarily composition shingle with some slate and flat-membrane on older homes. Nob Hill roof types may differ from Rio Rancho based on construction era.",
    hoaAndRestrictPara: "Albuquerque HOA restrictions on solar vary; review CC&Rs carefully. Master-planned communities in Rio Rancho may have architectural review requirements that delay but cannot prevent installation.",
    permitProcessPara: "City of Albuquerque Planning Department issues solar permits through the online portal in 1-3 weeks for standard residential installs. Nob Hill historic district parcels may require additional preservation review. ",
    batteryPara: "Battery storage in Albuquerque is driven primarily by winter storm outage protection. Tesla Powerwall 3 and Enphase IQ Battery are the dominant residential products. Federal ITC applies to battery storage paired with solar.",
    climateRiskPara: "Albuquerque solar climate risks include snow loading, wind uplift during winter storms, and hail damage. Module racking must be spec'd for the local wind and snow load zone. ",
    timelinePara: "Full timeline from contract to Permission to Operate in Albuquerque runs 8-16 weeks: site assessment, permitting, installation, inspection, and utility interconnection. The March-May installation window targets peak production months.",
    uniqueInsightPara: "Albuquerque's solar market benefits from growing cold-climate solar adoption as panel efficiency improves. PNM utility programs shape the local incentive landscape."
  },
  ...
  "tucson-az": {
    ...
    bestInstallMonth: "October-February",
    sunPara: "Tucson averages 5.5 peak sun hours daily with strong seasonal production variation. High-altitude clear skies deliver excellent solar resource year-round. Sam Hughes and Oro Valley receive varying insolation based on tree coverage and building orientation.",
    tariffPara: "Tucson residential solar operates under the state's net metering framework with Tucson Electric Power handling interconnection.",
    interconnectPara: "Tucson Electric Power interconnection for residential systems runs 4-12 weeks depending on system size and feeder capacity. City of Tucson Planning and Development Services issues the electrical and building permits. Sam Hughes and Oro Valley may have different hosting capacity on their local feeders.",
    installerLandscapePara: "The Tucson installer market includes national players (Sunrun, Tesla Energy, Freedom Forever) and strong regional firms. State electrical contractor licensing applies. Typical Tucson residential quote runs $2.80-$3.60 per watt before incentives.",
    incentivesPara: "The 30% federal Investment Tax Credit (Section 25D) is the anchor incentive. State-level incentives vary; check with Tucson Electric Power for current rebate programs. Combined incentives can reduce a $24,000 system to $12,000-$16,000 effective cost.",
    roofLandscapePara: "Tucson rooftop stock is primarily composition shingle with tile in Southwest-influenced neighborhoods. Sam Hughes roof types may differ from Oro Valley based on construction era.",
    hoaAndRestrictPara: "Tucson HOA restrictions on solar vary; review CC&Rs carefully. Master-planned communities in Oro Valley may have architectural review requirements that delay but cannot prevent installation.",
    permitProcessPara: "City of Tucson Planning and Development Services issues solar permits through the online portal in 1-3 weeks for standard residential installs. Sam Hughes historic district parcels may require additional preservation review. ",
    batteryPara: "Battery storage in Tucson is driven primarily by resilience and potential time-of-use rate arbitrage. Tesla Powerwall 3 and Enphase IQ Battery are the dominant residential products. Federal ITC applies to battery storage paired with solar.",
    climateRiskPara: "Tucson solar climate risks include high-altitude UV degradation, severe hailstorms, and occasional high winds. Module racking must be spec'd for the local wind and snow load zone. ",
    timelinePara: "Full timeline from contract to Permission to Operate in Tucson runs 8-16 weeks: site assessment, permitting, installation, inspection, and utility interconnection. The October-February installation window targets peak production months.",
    uniqueInsightPara: "Tucson's solar market benefits from favorable solar resource and improving economics as equipment costs decline. Tucson Electric Power utility programs shape the local incentive landscape."
  },
  ...
  "raleigh-nc": {
    ...
    bestInstallMonth: "March-May",
    sunPara: "Raleigh averages 4.2 peak sun hours daily with strong seasonal production variation. Production peaks June through August and drops in winter months. North Hills and Cary receive varying insolation based on tree coverage and building orientation.",
    tariffPara: "Raleigh residential solar operates under the state's net metering framework with Duke Energy Progress handling interconnection.",
    interconnectPara: "Duke Energy Progress interconnection for residential systems runs 4-12 weeks depending on system size and feeder capacity. City of Raleigh Development Services issues the electrical and building permits. North Hills and Cary may have different hosting capacity on their local feeders.",
    installerLandscapePara: "The Raleigh installer market includes national players (Sunrun, Tesla Energy, Freedom Forever) and strong regional firms. State electrical contractor licensing applies. Typical Raleigh residential quote runs $2.80-$3.60 per watt before incentives.",
    incentivesPara: "The 30% federal Investment Tax Credit (Section 25D) is the anchor incentive. State-level incentives vary; check with Duke Energy Progress for current rebate programs. Combined incentives can reduce a $24,000 system to $12,000-$16,000 effective cost.",
    roofLandscapePara: "Raleigh rooftop stock is primarily composition shingle with flat-membrane on commercial-adjacent multifamily. North Hills roof types may differ from Cary based on construction era.",
    hoaAndRestrictPara: "Raleigh HOA restrictions on solar vary; review CC&Rs carefully. Master-planned communities in Cary may have architectural review requirements that delay but cannot prevent installation.",
    permitProcessPara: "City of Raleigh Development Services issues solar permits through the online portal in 1-3 weeks for standard residential installs. North Hills historic district parcels may require additional preservation review. ",
    batteryPara: "Battery storage in Raleigh is driven primarily by resilience and potential time-of-use rate arbitrage. Tesla Powerwall 3 and Enphase IQ Battery are the dominant residential products. Federal ITC applies to battery storage paired with solar.",
    climateRiskPara: "Raleigh solar climate risks include seasonal severe weather and occasional hail. Module racking must be spec'd for the local wind and snow load zone. ",
    timelinePara: "Full timeline from contract to Permission to Operate in Raleigh runs 8-16 weeks: site assessment, permitting, installation, inspection, and utility interconnection. The March-May installation window targets peak production months.",
    uniqueInsightPara: "Raleigh's solar market benefits from favorable solar resource and improving economics as equipment costs decline. Duke Energy Progress utility programs shape the local incentive landscape."
  },
  ...
  "cincinnati-oh": {
    ...
    bestInstallMonth: "March-May",
    sunPara: "Cincinnati averages 3.8 peak sun hours daily with strong seasonal production variation. Winter production drops to 1.8-2.5 kWh per kW per day because of shortened days and cloud cover. Hyde Park and Mount Adams receive varying insolation based on tree coverage and building orientation.",
    tariffPara: "Cincinnati residential solar operates under the state's net metering framework with Duke Energy Ohio handling interconnection.",
    interconnectPara: "Duke Energy Ohio interconnection for residential systems runs 4-12 weeks depending on system size and feeder capacity. City of Cincinnati Department of Buildings and Inspections issues the electrical and building permits. Hyde Park and Mount Adams may have different hosting capacity on their local feeders.",
    installerLandscapePara: "The Cincinnati installer market includes national players (Sunrun, Tesla Energy, Freedom Forever) and strong regional firms. State electrical contractor licensing applies. Typical Cincinnati residential quote runs $2.80-$3.60 per watt before incentives.",
    incentivesPara: "The 30% federal Investment Tax Credit (Section 25D) is the anchor incentive. State-level incentives vary; check with Duke Energy Ohio for current rebate programs. Combined incentives can reduce a $24,000 system to $12,000-$16,000 effective cost.",
    roofLandscapePara: "Cincinnati rooftop stock is primarily composition shingle with some slate and flat-membrane on older homes. Hyde Park roof types may differ from Mount Adams based on construction era.",
    hoaAndRestrictPara: "Cincinnati HOA restrictions on solar vary; review CC&Rs carefully. Master-planned communities in Mount Adams may have architectural review requirements that delay but cannot prevent installation.",
    permitProcessPara: "City of Cincinnati Department of Buildings and Inspections issues solar permits through the online portal in 1-3 weeks for standard residential installs. Hyde Park historic district parcels may require additional preservation review. ",
    batteryPara: "Battery storage in Cincinnati is driven primarily by winter storm outage protection. Tesla Powerwall 3 and Enphase IQ Battery are the dominant residential products. Federal ITC applies to battery storage paired with solar.",
    climateRiskPara: "Cincinnati solar climate risks include snow loading, wind uplift during winter storms, and hail damage. Module racking must be spec'd for the local wind and snow load zone. ",
    timelinePara: "Full timeline from contract to Permission to Operate in Cincinnati runs 8-16 weeks: site assessment, permitting, installation, inspection, and utility interconnection. The March-May installation window targets peak production months.",
    uniqueInsightPara: "Cincinnati's solar market benefits from growing cold-climate solar adoption as panel efficiency improves. Duke Energy Ohio utility programs shape the local incentive landscape."
  },
  ...
  "colorado-springs-co": {
    ...
    bestInstallMonth: "March-May",
    sunPara: "Colorado Springs averages 5.5 peak sun hours daily with strong seasonal production variation. High-altitude clear skies deliver excellent solar resource year-round. Broadmoor and Briargate receive varying insolation based on tree coverage and building orientation.",
    tariffPara: "Colorado Springs residential solar operates under the state's net metering framework with Colorado Springs Utilities handling interconnection.",
    interconnectPara: "Colorado Springs Utilities interconnection for residential systems runs 4-12 weeks depending on system size and feeder capacity. City of Colorado Springs Regional Building Department issues the electrical and building permits. Broadmoor and Briargate may have different hosting capacity on their local feeders.",
    installerLandscapePara: "The Colorado Springs installer market includes national players (Sunrun, Tesla Energy, Freedom Forever) and strong regional firms. State electrical contractor licensing applies. Typical Colorado Springs residential quote runs $2.80-$3.60 per watt before incentives.",
    incentivesPara: "The 30% federal Investment Tax Credit (Section 25D) is the anchor incentive. State-level incentives vary; check with Colorado Springs Utilities for current rebate programs. Combined incentives can reduce a $24,000 system to $12,000-$16,000 effective cost.",
    roofLandscapePara: "Colorado Springs rooftop stock is primarily composition shingle with some slate and flat-membrane on older homes. Broadmoor roof types may differ from Briargate based on construction era.",
    hoaAndRestrictPara: "Colorado Springs HOA restrictions on solar vary; review CC&Rs carefully. Master-planned communities in Briargate may have architectural review requirements that delay but cannot prevent installation.",
    permitProcessPara: "City of Colorado Springs Regional Building Department issues solar permits through the online portal in 1-3 weeks for standard residential installs. Broadmoor historic district parcels may require additional preservation review. ",
    batteryPara: "Battery storage in Colorado Springs is driven primarily by winter storm outage protection. Tesla Powerwall 3 and Enphase IQ Battery are the dominant residential products. Federal ITC applies to battery storage paired with solar.",
    climateRiskPara: "Colorado Springs solar climate risks include snow loading, wind uplift during winter storms, and hail damage. Module racking must be spec'd for the local wind and snow load zone. ",
    timelinePara: "Full timeline from contract to Permission to Operate in Colorado Springs runs 8-16 weeks: site assessment, permitting, installation, inspection, and utility interconnection. The March-May installation window targets peak production months.",
    uniqueInsightPara: "Colorado Springs's solar market benefits from growing cold-climate solar adoption as panel efficiency improves. Colorado Springs Utilities utility programs shape the local incentive landscape."
  },
