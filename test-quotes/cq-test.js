  (function() {
    ...
    window.showResults = function() {
      ...
      html += '<div>';
      html += '<p style="font-size:12px; font-weight:700; color:var(--brand, #1e3a5f); margin:0 0 2px; text-transform:uppercase; letter-spacing:0.05em;">Woogoro Quote Analysis</p>';
      if (isTight) {
      ...
      // CTAs
      var emailSubject = encodeURIComponent("My " + serviceLabel + " Quote Comparison - Woogoro");
      ...
      html += '<a href="https://woogoro.com" style="text-decoration:none; display:inline-flex; align-items:center; gap:8px; color:#64748b; font-size:14px;">';
      html += '<img src="/images/trudy-peeking.png" alt="Trudy" width="32" /> Powered by <strong style="color:#1e3a5f;">Woogoro</strong> <span style="color:#94a3b8;">|</span> <span style="color:#3b82f6;">woogoro.com</span>';
      html += '</a></div>';
      html += '<div style="text-align:center; margin-top:8px;"><a href="mailto:hello@woogoro.com?subject=Woogoro Feedback" style="font-size:13px; color:#94a3b8; text-decoration:none;">Have a suggestion? Email hello@woogoro.com</a></div>';
    ...
    function buildEmailSummary(active, bestValue, questions, allFlags) {
      ...
      lines.push("Generated by Woogoro (woogoro.com)");
      lines.push("");
      ...
      lines.push("Compare more quotes at https://woogoro.com/compare-quotes.html");
      return lines.join("\n");
    }
