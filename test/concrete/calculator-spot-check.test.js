...
const SPECS = [
  { id: "std-driveway-600-se", label: "Standard driveway 600 sqft, SE", inputs: { projectType: "standard_driveway", sqft: 600, region: "southeast" }, band: { low: 4500, high: 12500 }, sources: "[PRICE-DRIFT-2026-1] Re-anchored 2026-07-30 from the 2026-06-09 drift report: standard driveway is $8-$20/sqft, i.e. $4,800-$12,000 national for 600sqft (old band $4-8.5k was ~35% low on both edges). SE 1.03x lands $4.94-12.36k. Calc $8,650 inside." },
  { id: "stamped-400-w", label: "Stamped concrete 400 sqft, W", inputs: { projectType: "stamped_concrete", sqft: 400, region: "west" }, band: { low: 4000, high: 15000 }, sources: "[PRICE-DRIFT-2026-1] Re-anchored 2026-07-30 from the 2026-06-09 drift report: stamped is $9-$30/sqft, i.e. $3,600-$12,000 national for 400sqft (old band low edge was +20% off). W 1.22x lands $4.39-14.64k. Calc $8,800 inside." },
