...
const SPECS = [
  { id: "wood-150-6ft-gate-nc", label: "Wood privacy 150 lf 6ft +gate, NC", inputs: { fenceType: "wood_privacy", linearFeet: 150, height: "6", includesGate: true, region: "southeast" }, band: { low: 5000, high: 9000 }, sources: "[PRICE-DRIFT-2026-1] Re-anchored 2026-07-30 from the 2026-06-09 drift report: wood privacy is $25-50/lf and a walk gate ~$1,300, i.e. $5,050-$8,800 national for 150lf 6ft +gate (old band $3.5-6.5k was +102% off at the low edge). SE 1.03x lands $5.2-9.07k. Calc $6,700 inside." },
