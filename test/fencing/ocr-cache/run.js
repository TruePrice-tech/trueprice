...
const EXPECTED = {
  ...
  "messy-comparison-fence-low.jpg": {
    "price": 5100,
    "minConfidence": "low"
  },
  "messy-comparison-fence-mid.jpg": {
    "price": 7400,
    "minConfidence": "low"
  },
  "messy-comparison-fence-high.jpg": {
    "price": 10800,
    "minConfidence": "low"
  }
};
...
if (!cached.length) {
  console.log("No cached OCR files. Run: node test/fencing/ocr-cache/refresh.js");
  process.exit(0);
}
...
for (const txt of cached) {
  ...
  try {
    const r = parser.parseExtractedTextMultiStrategy(text, "fencing");
...
console.log("── Layer 2 — fencing Real OCR Cache Tests ──");
