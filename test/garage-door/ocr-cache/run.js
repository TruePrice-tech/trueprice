...
const EXPECTED = {
  ...
  "messy-comparison-garage-low.jpg": {
    "price": 1420,
    "minConfidence": "low"
  },
  "messy-comparison-garage-mid.jpg": {
    "price": 2300,
    "minConfidence": "low"
  },
  "messy-comparison-garage-high.jpg": {
    "price": 3700,
    "minConfidence": "low"
  }
};
...
if (!cached.length) {
  console.log("No cached OCR files. Run: node test/garage-door/ocr-cache/refresh.js");
  process.exit(0);
}
...
for (const txt of cached) {
  ...
  try {
    const r = parser.parseExtractedTextMultiStrategy(text, "garage-door");
...
console.log("── Layer 2 — garage-door Real OCR Cache Tests ──");
