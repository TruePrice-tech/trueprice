...
const EXPECTED = {
  "comparison-gutters-low.png": {
    "price": 1260,
    "minConfidence": "low"
  },
  "comparison-gutters-mid.png": {
    "price": 2380,
    "minConfidence": "low"
  },
  "comparison-gutters-high.png": {
    "price": 5520,
    "minConfidence": "low"
  },
  "messy-comparison-gutters-low.jpg": {
    "price": 1260,
    "minConfidence": "low"
  },
  "messy-comparison-gutters-mid.jpg": {
    "price": 2380,
    "minConfidence": "low"
  },
  "messy-comparison-gutters-high.jpg": {
    "price": 5520,
    "minConfidence": "low"
  }
};
...
if (!cached.length) {
  console.log("No cached OCR files. Run: node test/gutters/ocr-cache/refresh.js");
  process.exit(0);
}
...
for (const txt of cached) {
  ...
  try {
    const r = parser.parseExtractedTextMultiStrategy(text, "gutters");
...
console.log("── Layer 2 — gutters Real OCR Cache Tests ──");
