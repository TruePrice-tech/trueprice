...
const EXPECTED = {
  "comparison-insul-low.png": {
    "price": 1730,
    "minConfidence": "low"
  },
  "comparison-insul-mid.png": {
    "price": 3025,
    "minConfidence": "low"
  },
  "comparison-insul-high.png": {
    "price": 5680,
    "minConfidence": "low"
  },
  "messy-comparison-insul-low.jpg": {
    "price": 1730,
    "minConfidence": "low"
  },
  "messy-comparison-insul-mid.jpg": {
    "price": 3025,
    "minConfidence": "low"
  },
  "messy-comparison-insul-high.jpg": {
    "price": 5680,
    "minConfidence": "low"
  }
};
...
if (!cached.length) {
  console.log("No cached OCR files. Run: node test/insulation/ocr-cache/refresh.js");
  process.exit(0);
}
...
for (const txt of cached) {
  ...
  try {
    const r = parser.parseExtractedTextMultiStrategy(text, "insulation");
...
console.log("── Layer 2 — insulation Real OCR Cache Tests ──");
