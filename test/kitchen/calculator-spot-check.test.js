...
const SPECS = [
  ...
  },
  {
    ...
    band: { low: 130000, high: 220000 },
    sources: "NKBA Cost vs Value 2024 NY metro upper-mid; This Old House NYC kitchen 2026.",
  },
  {
    id: "major-large-quartzite-custom-premium-ny",
    label: "Major upscale, large, quartzite, custom, premium, NY (NYC luxury)",
    inputs: { tier: "major", sizeIdx: 2, countertopKey: "quartzite", cabinetKey: "custom", applianceKey: "premium", region: "northeast" },
    band: { low: 350000, high: 600000 },
    sources: "NKBA Cost vs Value 2024 upscale-major + NYC metro; ProRemodeler luxury-kitchen 2026.",
  },
  {
    ...
    band: { low: 400000, high: 700000 },
    sources: "Forbes Home 2026 CA upscale luxury kitchen $200-500k+; expansive size pushes upper.",
  },
  {
