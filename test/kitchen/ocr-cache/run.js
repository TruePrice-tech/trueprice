...
const EXPECTED = {
  "comparison-kitchen-low.png": {
    "price": 13850,
    "minConfidence": "low"
  },
  "comparison-kitchen-mid.png": {
    "price": 27250,
    "minConfidence": "low"
  },
  "comparison-kitchen-high.png": {
    "price": 57200,
    "minConfidence": "low"
  },
  "messy-comparison-kitchen-low.jpg": {
    "price": 13850,
    "minConfidence": "low"
  },
  "messy-comparison-kitchen-mid.jpg": {
    "price": 27250,
    "minConfidence": "low"
  },
  "messy-comparison-kitchen-high.jpg": {
    "price": 57200,
    "minConfidence": "low"
  }
};
...
if (!cached.length) {
  console.log("No cached OCR files. Run: node test/kitchen/ocr-cache/refresh.js");
  process.exit(0);
}
...
for (const txt of cached) {
  ...
  try {
    const r = parser.parseExtractedTextMultiStrategy(text, "kitchen");
...
console.log("── Layer 2 — kitchen Real OCR Cache Tests ──");
