...
const SPECS = [
  { id: "er-moderate-insured-in-ne", label: "ER moderate visit, in-network insured, NE", inputs: { serviceType: "er", subType: "moderate", insuranceKey: "insured_in", region: "northeast" }, band: { low: 200, high: 1500 }, sources: "RAND/Peterson 2026 ER moderate $300-1500 patient OOP after deductible." },
  { id: "knee-replacement-medicare-mw", label: "Knee replacement, Medicare, MW", inputs: { serviceType: "surgery", subType: "knee_replacement", insuranceKey: "medicare", region: "midwest" }, band: { low: 2500, high: 11000 }, sources: "Medicare Part A/B 2026 inpatient cost-sharing $3-10k." },
