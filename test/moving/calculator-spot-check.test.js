...
const SPECS = [
  { id: "local-2br-under50-none-nc", label: "Local 2BR <50mi NC", inputs: { moveType: "local", homeSize: "2br", distance: "under_50", packing: "none", specialItems: "none", region: "southeast" }, band: { low: 1200, high: 2500 }, sources: "HomeGuide 2026 local 2BR $1.2-2.5k." },
  { id: "ld-3br-1000plus-partial-ca-piano", label: "Long-distance 3BR 1000+mi partial CA +piano", inputs: { moveType: "long_distance", homeSize: "3br", distance: "1000_plus", packing: "partial", specialItems: "piano", region: "west" }, band: { low: 12000, high: 25000 }, sources: "Forbes 2026 long-distance 3BR cross-country $12-25k." },
