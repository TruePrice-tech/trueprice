...
const EXPECTED = {
  "comparison-paint-low.png": {
    "price": 3280,
    "minConfidence": "low"
  },
  "comparison-paint-mid.png": {
    "price": 6680,
    "minConfidence": "low"
  },
  "comparison-paint-high.png": {
    "price": 12400,
    "minConfidence": "low"
  },
  "messy-comparison-paint-low.jpg": {
    "price": 3280,
    "minConfidence": "low"
  },
  "messy-comparison-paint-mid.jpg": {
    "price": 6680,
    "minConfidence": "low"
  },
  "messy-comparison-paint-high.jpg": {
    "price": 12400,
    "minConfidence": "low"
  }
};
...
if (!cached.length) {
  console.log("No cached OCR files. Run: node test/painting/ocr-cache/refresh.js");
  process.exit(0);
}
...
console.log("── Layer 2 — painting Real OCR Cache Tests ──");
