...
const EXPECTED = {
  "comparison-siding-low.png":        { price: 9040,  minConfidence: "low" },
  "comparison-siding-mid.png":        { price: 14880, minConfidence: "low" },
  "comparison-siding-high.png":       { price: 23620, minConfidence: "low" },
  "messy-comparison-siding-low.jpg":  { price: 9040,  minConfidence: "low" },
  "messy-comparison-siding-mid.jpg":  { price: 14880, minConfidence: "low" },
  "messy-comparison-siding-high.jpg": { price: 23620, minConfidence: "low" }
};
...
if (!cached.length) {
  console.log("No cached OCR files. Run: node test/siding/ocr-cache/refresh.js");
  process.exit(0);
}
...
for (const txt of cached) {
  ...
  try {
    const r = parser.parseExtractedTextMultiStrategy(text, "siding");
...
console.log("── Layer 2 — siding Real OCR Cache Tests ──");
